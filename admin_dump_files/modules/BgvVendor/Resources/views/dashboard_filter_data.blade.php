                    ...
                    <div class="row g-3">
                        <div class="col-12 col-md-6">
                            @if($type == "total_application")
                               <div class="card-title h4 fw-bold">Total Applications</div>
                            @elseif($type == "complete_application")
                               <div class="card-title h4 fw-bold">Completed BGV Applications</div>
                            @elseif($type == "rejected_application")
                               <div class="card-title h4 fw-bold">Rejected BGV Applications</div>
                            @elseif($type == "pending_application")
                               <div class="card-title h4 fw-bold">Pending BGV Applications</div>
                             @elseif($type == "hold_application")
                               <div class="card-title h4 fw-bold">Hold BGV Applications</div>
                            @else
                               <div class="card-title h4 fw-bold">N/A</div>
                            @endif
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">BGV Vendor</a></li>
                                    @if($type == "total_application")
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Total Applications Overview</a></li>
                                    @elseif($type == "complete_application")
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Total Applications Completed Overview</a></li>
                                    @elseif($type == "rejected_application")
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Total Applications Rejected Overview</a></li>
                                    @elseif($type == "pending_application")
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Total Applications Pending Overview</a></li>
                                    @elseif($type == "hold_application")
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Total Applications Hold Overview</a></li>
                                    @else
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">N/A</a></li>
                                    @endif
                                </ol>
                            </nav>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="row d-flex justify-content-end">
                                @if($type == "total_application")
                                    <div class="col-6 p-3 rounded d-flex align-items-center" style="background:#ffffff;">
                                        <div class="me-2">
                                            <i class="bi bi-calendar p-2 fw-bold" style="background: #3BB54A12; border-radius: 25%; color:#68c674;"></i>
                                        </div>
                                        <div>
                                            <label for="">Carry Forward Applications</label>
                                        </div>
                                    </div>
                                    <!--<div class="col-md-4 col-12 p-3 rounded d-flex flex-column flex-sm-row align-items-center" style="background:#ffffff;">-->
                                    <!--    <a href="{{ url('/admin/dashboard') }}{{ ($from_date ? '?from_date=' . $from_date : '') }}{{ ($to_date ? ($from_date ? '&to_date=' . $to_date : '?to_date=' . $to_date) : '') }}" class="btn btn-dark px-4">Back</a>-->
                    ...
                    <div class="row d-flex">
                        ...
                        <div class="col-md-3 col-12 p-3 rounded d-flex align-items-center" style="background:#ffffff;">
                         ...
                         <div class="col-md-3 col-12 p-3 rounded d-flex align-items-center" style="background:#ffffff;">
                            ...
                            <!--</div>-->
                            <div>
                                <label for="Fil_CityID">Select City</label>
                                <select class="form-select border-0 custom-select2-field" id="Fil_CityID" style="width:100%; padding:10px 20px;" onchange="CitywiseFilter(this.value)">
                        ...
                        @endif
                        <div class="{{$type == 'total_application' ? 'col-12' : 'col-md-3' }} p-3 rounded d-flex flex-column flex-sm-row align-items-center justify-content-end" style="background:#ffffff;">
                            <button class="btn btn-dark me-2 px-4" onclick="DatewiseFiler()">Filter</button>
                            <a href="javascript:void(0);" onclick="removeOption()" class="btn btn-dark px-4">Reset</a>
                        </div>
                    </div>
