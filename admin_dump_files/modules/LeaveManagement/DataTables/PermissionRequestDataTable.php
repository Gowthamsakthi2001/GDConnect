...
use Carbon\Carbon;
class PermissionRequestDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('days', function ($row) {
                return optional($row->leave)->days.' hour' ?? 'N/A';
            })
    ...
    {
        // return LeaveRequest::query()->with(['deliveryman','leave'])->where('reject_status',1)->orderBy('id', 'desc');
  ...
  public function getColumns(): array
    {
        return [
            ...
            Column::make('days')->title('Permission Hour')->defaultContent('N/A')->searchable(true),
            Column::make('permission_date')->title('Permission Date')->defaultContent('N/A')->searchable(true),
            Column::make('apply_days')->title('Applied Hour')->defaultContent('N/A')->searchable(true),
