...
<style>
    ...
    <div class="main-content">
                ...
                <div class="row g-3">
                    <div class="col-md-4 d-flex align-items-center">
                        <div class="card-title h5 custom-dark m-0"> <a
                                ...
                                class="btn btn-sm shadow me-2"><i class="bi bi-arrow-left"></i> </a>Create a Module
                        </div>
                    </div>
                </div>
        ...
        <div class="card my-3">
            ...
            <div class="card-body pt-3">
                <form action="javascript:void(0);" method="POST" id="ModuleCreateForm" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                <label class="input-label mb-2 ms-1">Assign Roles <span class="text-danger fw-bold">*</span></label>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12 text-end">
                            ...
                            <button type="submit" class="btn btn-success" id="SaveModuleBtn">Save Module</button>
                        </div>
                    </div>
    ...
    <script>
       ...
       $("#ModuleCreateForm").submit(function (e) {
            ...
            var $submitBtn = $("#SaveModuleBtn");
            var originalText = $submitBtn.html();
            $submitBtn.prop("disabled", true).html("⏳ Submitting...");
        
            $.ajax({
                url: "{{ route('admin.Green-Drive-Ev.master_management.sidebar_module.store') }}",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
