  ...
  overflow-x: hidden !important;
    ...
    <div class="main-content">
                ...
                <div class="card-header" style="background:#fbfbfb;">
                    <div class="row g-3">
                        <div class="col-md-6 d-flex align-items-center">
                            <div class="card-title h5 custom-dark m-0">Registration Type Master<span class="badge text-muted shadow ms-2 p-2" style="background:rgb(234,234,234);">{{count($lists)}}</span></div>
                        ...
                        <div class="col-md-6 d-flex gap-2 align-items-center justify-content-end">
                            ...
                            <div class="text-center d-flex gap-2">
                                ...
                                <div class="m-2 bg-white p-2 px-3 border-gray" onclick="REG_Excel_Export()"><i class="bi bi-download fs-17 me-1"></i> Export</div>
                                ...
                                <div class="m-2 btn btn-success d-flex align-items-center px-3"
                                    onclick="AddorEditRegistrationTypeModal('0',this)"
        ...
        <div class="table-responsive">
                    <table id="RegistrationTableList" class="table text-center" style="width: 100%;">
                        <thead class="bg-white rounded" style="background:white !important; color:black !important;">
                            <tr>
                                ...
                                <th scope="col" class="custom-dark text-center">Registration Type</th>
                                ...
                                <tr>
                                   ...
                                   <td>
                                       <a href="javascript:void(0);" 
                                           ...
                                           onclick="AddorEditRegistrationTypeModal('{{ $val->id }}', this)" 
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRightHypothecation01" aria-labelledby="offcanvasRightHypothecation01Label">
          <div class="offcanvas-header">
            <h5 class="custom-dark" id="offcanvasRightHypothecation01Label">Registration Type Filter</h5>
            <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
          </div>
          <div class="offcanvas-body">
        
            <div class="d-flex gap-2 mb-3">
                <button class="btn btn-outline-secondary w-50" onclick="clearRegistrationFilter()">Clear All</button>
                <button class="btn btn-success w-50" onclick="applyRegistrationFilter()">Apply</button>
            </div>
     ...
     <div class="modal fade" id="AddorEditRegistrationType" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="AddorEditRegistrationTypeLabel" aria-hidden="true">
        <form id="AddorEdit_REG_Form" action="javascript:void(0);" method="POST">
            @csrf
            <input type="hidden" name="edit_id" id="Edit_REG_ID" value="">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="AddorEditRegistrationTypeLabel">Create Registration Type</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                             ...
                             <div class="col-12 mb-3">
                                <label class="input-label mb-2 ms-1" for="name">Registration Type <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="registration_type" id="registration_type" class="form-control" placeholder="Enter Registration Type">
...
<script>
    ...
    function REG_Excel_Export(){
        ...
        const url = `{{ route('admin.Green-Drive-Ev.master_management.registration_type.export_registration_type') }}?${params.toString()}`;
        window.location.href = url;
    }
    
    $(document).ready(function () {
      $('#RegistrationTableList').DataTable({
            // dom: 'Blfrtip',
            // dom: 'frtip',
  ...
  function AddorEditRegistrationTypeModal(id, el) {
        if (id == 0) {
            $("#AddorEditRegistrationTypeLabel").text("Create Registration Type");
            $("#AddorEditRegistrationType").modal('show');
            $('#AddorEditRegistrationType form').trigger('reset');
        } else {
            $("#AddorEditRegistrationTypeLabel").text("Update Registration Type");
            ...
            $("#AddorEditRegistrationType").modal('show');
            $("#Edit_REG_ID").val(id);
            $('#registration_type').val(ins_name);
            $("#statusvalue").val(status);
        }
    }

  
$("#AddorEdit_REG_Form").submit(function (e) {
    e.preventDefault();
    ...
    var redirect = "{{ route('admin.Green-Drive-Ev.master_management.registration_type.index') }}";
    ...
    $.ajax({
        url: "{{ route('admin.Green-Drive-Ev.master_management.registration_type.store') }}",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
        success: function (response) {
            ...
            if (response.success == true) {
                ...
                $("#AddorEditRegistrationType").modal('hide');
                form.reset();
                setTimeout(function () {
    ...
    $('.toggle-status').change(function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                // Proceed with AJAX
                $.ajax({
                    url: "{{ route('admin.Green-Drive-Ev.master_management.registration_type.status_update') }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
                        id: brandId,
