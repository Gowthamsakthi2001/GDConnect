...
<style>
    ...
    <div class="main-content">
                ...
                <div class="card-header" style="background:#fbfbfb;">
                    <div class="row g-3">
                        <div class="col-md-6 d-flex align-items-center">
                            <div class="card-title h5 custom-dark m-0">Color Master <span class="badge text-muted shadow ms-2 p-2" style="background:rgb(234,234,234);">{{$data->count()}}</span></div>
                        ...
                        <div class="col-md-6 d-flex gap-2 align-items-center justify-content-end">
                            ...
                            <div class="text-center d-flex gap-2">
                                ...
                                <div class="m-2 btn btn-success d-flex align-items-center px-3"
                                    style="cursor: pointer;"      data-bs-toggle="modal" data-bs-target="#AddColorMaster">
                    ...
                    <table id="ColorMasterTable_List" class="table text-left" style="width: 100%;">
                          <thead class="bg-white rounded" style="background:white !important; color:black !important;">
                            <tr>
                              ...
                              <th scope="col" class="custom-dark">Color Name</th>
                        ...
                        <tbody class="bg-white border border-white">
                          ...
                          @if(isset($data))
                            @foreach($data as $val)
                                ...
                                {{-- Action --}}
                                <td class="text-start">
                                    <a href="javascript:void(0);" class="text-success editColorBtn" data-id="{{ $val->id }}" data-name="{{$val->name}}" data-status="{{$val->status}}" style="font-size: 1.2rem;">
        ...
        <div class="modal fade" id="AddColorMaster" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            aria-labelledby="AddColorMaster" aria-hidden="true">
            <form id="AddColorMaster_From" action="javascript:void(0);" method="POST">
                @csrf
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" >Create Color OEM</h5>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                 ...
                                 <div class="col-12 mb-3">
                                    <label for="vehicle_type" class="mb-2 ms-1">Color Name
                                    <span class="text-danger">*</span></label>
                                        
                                    <input class="form-control basic-single" placeholder="Enter Color Name" name="color_name" required>
                                </div>
            ...
            <div class="modal fade" id="EditColorMaster" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            aria-labelledby="EditColorMaster" aria-hidden="true">
            <form id="EditColorMaster_From" action="javascript:void(0);" method="POST">
                @csrf
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" >Update Color Master</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                 ...
                                 <div class="col-12 mb-3">
                                    ...
                                    <input class="form-control basic-single" placeholder="Enter Color Name" name="color_name" id="color_name" required>
                                </div>
...
<script>
    $("#AddColorMaster_From").submit(function (e) {
        e.preventDefault();
        ...
        var redirect = "{{ route('admin.Green-Drive-Ev.master_management.color_master.index') }}";
        ...
        $.ajax({
            url: "{{ route('admin.Green-Drive-Ev.master_management.color_master.store') }}",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
    ...
    $(document).on('click', '.editColorBtn', function () {
        ...
        $('#EditColorMaster').modal('show');
    });

    
        $("#EditColorMaster_From").submit(function (e) {
        e.preventDefault();
        ...
        $.ajax({
            url: "{{ route('admin.Green-Drive-Ev.master_management.color_master.update') }}", // Update route
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
    ...
    $('.toggle-status').change(function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                // Proceed with AJAX
                $.ajax({
                    url: "{{ route('admin.Green-Drive-Ev.master_management.color_master.status_update') }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
                        id: Id,
...
<script>
  document.getElementById('exportBtn').addEventListener('click', function () {
    ...
    const url = `{{ route('admin.Green-Drive-Ev.master_management.color_master.export') }}?${params.toString()}`;
