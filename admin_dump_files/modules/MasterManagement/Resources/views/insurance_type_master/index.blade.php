  ...
  overflow-x: hidden !important;
                ...
                <div class="card-header" style="background:#fbfbfb;">
                    <div class="row g-3">
                        <div class="col-md-6 d-flex align-items-center">
                            <div class="card-title h5 custom-dark m-0">Insurance Type Master<span class="badge text-muted shadow ms-2 p-2" style="background:rgb(234,234,234);">{{count($lists)}}</span></div>
                        ...
                        <div class="col-md-6 d-flex gap-2 align-items-center justify-content-end">
                            ...
                            <div class="text-center d-flex gap-2">
                                ...
                                <div class="m-2 bg-white p-2 px-3 border-gray" onclick="IN_Excel_Export()"><i class="bi bi-download fs-17 me-1"></i> Export</div>
                                ...
                                <div class="m-2 btn btn-success d-flex align-items-center px-3"
                                    onclick="AddorEditInsuranceTypeModal('0',this)"
                    ...
                    <table id="HypocationTableList" class="table text-center" style="width: 100%;">
                        <thead class="bg-white rounded" style="background:white !important; color:black !important;">
                            <tr>
                                ...
                                <th scope="col" class="custom-dark text-center">Insurance Type</th>
                                ...
                                <tr>
                                   ...
                                   <td>
                                       <a href="javascript:void(0);" 
                                           ...
                                           onclick="AddorEditInsuranceTypeModal('{{ $val->id }}', this)" 
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRightHypothecation01" aria-labelledby="offcanvasRightHypothecation01Label">
          <div class="offcanvas-header">
            <h5 class="custom-dark" id="offcanvasRightHypothecation01Label">Insurance Type Filter</h5>
            <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
          </div>
          <div class="offcanvas-body">
        
            <div class="d-flex gap-2 mb-3">
                <button class="btn btn-outline-secondary w-50" onclick="clearInsuranceFilter()">Clear All</button>
                <button class="btn btn-success w-50" onclick="applyInsuranceFilter()">Apply</button>
            </div>
     ...
     <div class="modal fade" id="AddorEditInsuranceType" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="AddorEditInsuranceTypeLabel" aria-hidden="true">
        <form id="AddorEdit_IN_Form" action="javascript:void(0);" method="POST">
            @csrf
            <input type="hidden" name="edit_id" id="Edit_IN_ID" value="">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="AddorEditInsuranceTypeLabel">Enter a Details</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                             ...
                             <div class="col-12 mb-3">
                                <label class="input-label mb-2 ms-1" for="name">Insurance Type <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="insurance_type" id="insurance_type" class="form-control" placeholder="Enter Insurance Type">
...
<script>
    ...
    function IN_Excel_Export(){
        ...
        const url = `{{ route('admin.Green-Drive-Ev.master_management.insurance_type.export_insurence_type') }}?${params.toString()}`;
  ...
  function AddorEditInsuranceTypeModal(id, el) {
        if (id == 0) {
            $("#AddorEditInsuranceTypeLabel").text("Create Insurance Type");
            $("#AddorEditInsuranceType").modal('show');
            $('#AddorEditInsuranceType form').trigger('reset');
        } else {
            $("#AddorEditInsuranceTypeLabel").text("Update Insurance Type");
            ...
            $("#AddorEditInsuranceType").modal('show');
            $("#Edit_IN_ID").val(id);
            $('#insurance_type').val(ins_name);
            $("#statusvalue").val(status);
        }
    }

  
$("#AddorEdit_IN_Form").submit(function (e) {
    e.preventDefault();
    ...
    var redirect = "{{ route('admin.Green-Drive-Ev.master_management.insurance_type.index') }}";
    ...
    $.ajax({
        url: "{{ route('admin.Green-Drive-Ev.master_management.insurance_type.store') }}",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
        success: function (response) {
            ...
            if (response.success == true) {
                ...
                $("#AddorEditInsuranceType").modal('hide');
                form.reset();
                setTimeout(function () {
    ...
    $('.toggle-status').change(function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                // Proceed with AJAX
                $.ajax({
                    url: "{{ route('admin.Green-Drive-Ev.master_management.insurance_type.status_update') }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
                        id: brandId,
