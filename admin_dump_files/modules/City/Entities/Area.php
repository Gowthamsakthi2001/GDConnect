...
class Area extends Model
{
    ...
    public function actionBtn($tableId = 'Area-table')
    {
        return '
            <a href="' . route('admin.Green-Drive-Ev.Area.edit', $this->id) . '" class="btn btn-success-soft btn-sm me-1">
            ...
            <button onclick="route_alert(\'' . route('admin.Green-Drive-Ev.Area.delete', $this->id) . '\', \'Delete this Area\')" class="btn btn-danger-soft btn-sm">
