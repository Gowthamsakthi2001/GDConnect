...
class city extends Model
{
    ...
    // Specify the table name (if different from the default "cities")
    protected $table = 'ev_tbl_city';
    ...
    public function actionBtn($tableId = 'city-table')
    {
        return '
            <a href="' . route('admin.Green-Drive-Ev.City.edit', $this->id) . '" class="btn btn-success-soft btn-sm me-1">
            ...
            <button onclick="route_alert(\'' . route('admin.Green-Drive-Ev.City.delete', $this->id) . '\', \'Delete this City\')" class="btn btn-danger-soft btn-sm">
    ...
    {
        return $this->belongsTo(EVState::class);
    }
}
