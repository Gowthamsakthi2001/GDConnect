...
use Modules\AssetMaster\Database\factories\ModelMasterChargerFactory;

class ModelMasterCharger extends Model
{
    use HasFactory;

    protected $table = 'ev_modal_master_charger';
    ...
    protected $casts = [
     ...
     public function actionBtn($tableId = 'modal-master-charger-table')
    {
        return '
            <a href="' . route('admin.Green-Drive-Ev.asset-master.model_master_charger_edit', $this->id) . '" class="btn btn-success-soft btn-sm me-1">
            ...
            <button onclick="route_alert(\'' . route('admin.Green-Drive-Ev.asset-master.model_master_charger_delete', $this->id) . '\', \'Delete this Master Modal Charger\')" class="btn btn-danger-soft btn-sm">
