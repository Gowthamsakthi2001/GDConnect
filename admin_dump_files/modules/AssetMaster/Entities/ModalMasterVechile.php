...
use Modules\AssetMaster\Database\factories\ModalMasterVechileFactory;

class ModalMasterVechile extends Model
{
    use HasFactory;

    protected $table = 'ev_modal_vehicles'; // or change to your table name if different
    ...
    protected $fillable = [
        ...
        'max_speed_km_h',
        'tyre_type',
        'front_tyre_dimensions',
        'rear_tyre_dimensions',
        'vehicle_type',
        'range_km_noload',
        'range_km_fullload',
        'vehicle_mode',
        ...
        'peak_curr_cntrlr',
        'cntrlr_can_enabled',
        'acceleration_0to40_sec',
        'head_light_type',
        'vehicle_reverse_mode',
        'inbuilt_iot',
        'status',
    ];
    
    public function actionBtn($tableId = 'modal-master-vechile-table')
    {
        return '
            <a href="' . route('admin.Green-Drive-Ev.asset-master.edit', $this->id) . '" class="btn btn-success-soft btn-sm me-1">
            ...
            <button onclick="route_alert(\'' . route('admin.Green-Drive-Ev.asset-master.delete', $this->id) . '\', \'Delete this Vechile\')" class="btn btn-danger-soft btn-sm">
    ...
    protected static function newFactory(): ModalMasterVechileFactory
    {
        //return ModalMasterVechileFactory::new();
    }
}
