...
use Modules\AssetMaster\Database\factories\PoTableFactory;

class PoTable extends Model
{
    use HasFactory;

   protected $table = 'ev_po_table';
    ...
    public function actionBtn($tableId = 'po-table')
    {
        return '
            <a href="' . route('admin.Green-Drive-Ev.asset-master.po_table_edit', $this->id) . '" class="btn btn-success-soft btn-sm me-1">
            ...
            <button onclick="route_alert(\'' . route('admin.Green-Drive-Ev.asset-master.po_table_delete', $this->id) . '\', \'Delete this PoTable\')" class="btn btn-danger-soft btn-sm">
