...
use Modules\AssetMaster\Database\factories\AssetMasterChargerFactory;

class AssetMasterCharger extends Model
{
    use HasFactory;

    protected $table = 'ev_asset_master_charger';
    ...
    public function actionBtn($tableId = 'asset-master-charger')
    {
        return '
            <a href="' . route('admin.Green-Drive-Ev.asset-master.asset_master_charger_edit', $this->id) . '" class="btn btn-success-soft btn-sm me-1">
            ...
            <button onclick="route_alert(\'' . route('admin.Green-Drive-Ev.asset-master.asset_master_charger_delete', $this->id) . '\', \'Delete this AssetMasterCharger\')" class="btn btn-danger-soft btn-sm">
