...
use Modules\AssetMaster\Database\factories\AssetMasterBatteryFactory;

class AssetMasterBattery extends Model
{
    use HasFactory;

    protected $table = 'ev_asset_master_battery';
    ...
    public function actionBtn($tableId = 'asset-master-battery')
    {
        return '
            <a href="' . route('admin.Green-Drive-Ev.asset-master.asset_master_battery_edit', $this->id) . '" class="btn btn-success-soft btn-sm me-1">
            ...
            <button onclick="route_alert(\'' . route('admin.Green-Drive-Ev.asset-master.asset_master_battery_delete', $this->id) . '\', \'Delete this AssetMasterBattery\')" class="btn btn-danger-soft btn-sm">
