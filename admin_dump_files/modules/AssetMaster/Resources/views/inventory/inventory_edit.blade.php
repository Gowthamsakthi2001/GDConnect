...
.nav-pills .nav-link.active {
    ...
    <div class="main-content">
                ...
                <div class="card-header" style="background:#fbfbfb;">
                    <div class="row g-3">
                        <div class="col-md-6 d-flex align-items-center">
                              <div class="card-title h5 custom-dark m-0"> <a href="{{route('admin.asset_management.asset_master.inventory.list')}}" class="btn btn-sm shadow me-2"><i class="bi bi-arrow-left"></i> </a>Update Asset Details
                              </div>
                        </div>
     ...
     <div class="card my-3">
            ...
            <div class="card">
                <div class="card-body">
                    <form id="InventoryForm" action="javascript:void(0);" method="post" enctype="multipart/form-data">
                        @csrf
                      <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control bg-white" name="hypothecation_document" id="hypothecation_document" accept="image/png,image/jpeg,image/jpg,application/pdf" onchange="showImagePreview(this,'hypothecation_Image')">
                            </div>
                        </div>
                      ...
                      <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <select class="form-select custom-select2-field form-control-sm" name="vehicle_status" id="vehicle_status" required>
                                    <option value="">Select</option>
                                    @if(isset($inventory_locations))
                                       @foreach($inventory_locations as $val)
                                          <option value="{{$val->id}}" {{ (isset($data->transfer_status) && $data->transfer_status == $val->id) ? 'selected' : '' }} >{{$val->name}}</option>
                                       @endforeach
                                    @endif
                                </select>
                          ...
                          <div class="col-12 text-end gap-4 d-block">
...
$("#UpdateVehicle").on("click", function(e) {
    ...
    const id = `{{$data->assetVehicle->id}}`; // Blade will render the ID value here
    ...
    $.ajax({
        url: "{{ route('admin.asset_management.asset_master.inventory.update') }}",
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
        success: function(response) {
            ...
            if (response.success) {
                Swal.fire({
                    ...
                    window.location.href = "{{ route('admin.asset_management.asset_master.inventory.list') }}";
                });
            } else {
                Swal.fire({
                    icon: 'warning',
