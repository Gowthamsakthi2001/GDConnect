    ...
    <div class="page-header">
         <h2 class="page-header-title">            
               <div class="d-flex justify-content-between">
                    <div>
                        <img src="{{asset('admin-assets/icons/custom/employees-icon.webp')}}" class="img-fluid rounded"><span class="ps-2"> Add Employee</span>
                    </div>
               </div>
            </h2>
    </div>
            ...
            <form  method="POST" enctype="multipart/form-data" id="wizardForm" class=" g-3 p-3">
                ...
                <div id="wizard">
                    ...
                    <div class="wizard-step">
                             <h5 class="text-primary">{{'Employee Info'}}</h5>
                                ...
                                <div class="row mt-3">
                                        ...
                                        <input type="hidden" name="work_type" id="work_type" value="in-house">
                                </div>
    ...
    function updateProgressBar() {
       ...
       function step_two() {
        ...
        function step_three() {
            ...
            // 'driving_license_front', 'driving_license_back','license_number'
            ];
            let valid = true;
