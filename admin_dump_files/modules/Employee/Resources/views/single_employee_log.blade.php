<x-app-layout>
                ...
                <div class="card-body scrollable-content">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-5 text-center">
                            <img src="{{ asset('public/EV/images/photos/'.$dm->photo) }}" class="img-fluid rounded-circle" alt="Employee Image" style="width: 150px; height: 150px; object-fit: cover;">
                        </div>
            ...
            <div class="card h-100">
                <div class="card-body scrollable-content">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-7 mt-3 mt-md-0">
                            <p><b>First Name : </b> {{ $dm->first_name }}</p>
                            <p><b>Date OF Birth : </b> {{ date('d-m-Y',strtotime($dm->date_of_birth)) }}</p>
                            <p><b>Mobile : </b> {{ $dm->mobile_number }} </p>
                            <p><b>Father/ Mother/ Guardian Name : </b><br> {{ $dm->father_name }} </p>
                            <p><b>Father/ Mother/ Guardian Contact No : </b> <br>{{ $dm->father_mobile_number }} </p>
    ...
    <div class="my-4">
        <h4 class="text-muted mb-1">{{ 'Employee Logs Summary' }}</h4>
               ...
               <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                ...
                <div class="d-flex align-items-end flex-wrap gap-3">
                    ...
                    <div class="period-field d-none">
                        ...
                        <input type="date" name="from_date" id="FromDate" class="form-control form-control-sm" max="{{date('Y-m-d')}}">
                    </div>
...
<script type="text/javascript">
        ...
        document.getElementById('download-btn').addEventListener('click', function() {
            ...
            XLSX.writeFile(wb, 'Employee_log_list.xlsx'); 
        });
