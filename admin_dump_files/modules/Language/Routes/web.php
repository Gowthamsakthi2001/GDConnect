...
Route::prefix('admin/language')->as('admin.language.')->middleware('auth')->group(function () {
...
Route::get('/change-local', [LocalizeController::class, 'changeLocal'])->name('local.change')->middleware('auth');
Route::get('/get-localize', [LocalizeController::class, 'index'])->name('local.get-localize')->middleware('auth');
Route::post('/get-localize', [LocalizeController::class, 'store'])->middleware('auth');
