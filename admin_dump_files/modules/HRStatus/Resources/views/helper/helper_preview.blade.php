                ...
                <div class="row d-flex justify-content-between align-items-center flex-nowrap">
                        ...
                        <div class="d-flex justify-content-start align-items-center">
                            <div>
                                ...
                                <div class="col-12 text-center my-3">
                                    ...
                                    $photoFile = public_path('EV/images/photos/' . $helper->photo);
                                    $profileImage = (!empty($helper->photo) && file_exists($photoFile))
                                    ? asset('EV/images/photos/' . $helper->photo)
                                    : $defaultProfile;
                                    @endphp
                    ...
                    <div class="col-auto">
                        ...
                        <div class="d-flex justify-content-end align-items-center gap-2 flex-nowrap">
                            ...
                            <a href="{{ route('admin.Green-Drive-Ev.employee_categories.helper_list') }}"
                    ...
                    <div class="tab-pane fade show active" id="pills-basic-information" role="tabpanel"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body custom-card-body">
                                <form id="employeeForm" method="POST" action="{{ route('admin.Green-Drive-Ev.employee_categories.helper_update', $helper->id) }}">
                                    @csrf
                                    @method('POST')
                                    <div class="row">
                                        ...
                                        <div class="col-12 text-center my-3">
                                            @php
                                            $profileImage = $helper->photo
                                            ? (file_exists(public_path('EV/images/photos/' . $helper->photo))
                                            ? asset('EV/images/photos/' . $helper->photo)
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" class="form-control bg-white" name="mobile_number"
                                                    ...
                                                    value="{{$helper->mobile_number}}" readonly>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="first_name"
                                                    id="f_name" value="{{$helper->first_name}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="last_name"
                                                    id="l_name" value="{{$helper->last_name}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="email"
                                                    id="email" value="{{$helper->email}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="gender"
                                                    id="gender" value="{{$helper->gender}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="house_no"
                                                    id="house_no" value="{{$helper->house_no}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="street_name"
                                                    id="street_name" value="{{$helper->street_name}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control basic-single bg-white" id="current_city_id" name="current_city_id" disabled>
                                                    ...
                                                    <option value="{{ $city->id }}" {{ $helper->current_city_id == $city->id ? 'selected' : '' }}>
                                                        {{ $city->city_name }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group mt-3">
                                                ...
                                                <select class="form-control basic-single bg-white" id="interested_city_id" name="interested_city_id" disabled>
                                                    @foreach($cities as $city)
                                                    <option value="{{ $city->id }}" {{ $helper->interested_city_id == $city->id ? 'selected' : '' }}>
                                                        {{ $city->city_name }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="pincode"
                                                    id="pincode" value="{{$helper->pincode}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white"
                                                    name="alternative_number" id="alternative_number" value="{{$helper->alternative_number}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white"
                                                    name="alternative_number" id="alternative_number" value="{{$helper->work_type}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="account_holder_name"
                                                    id="ac_holder_name" value="{{$helper->account_holder_name}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="bank_name"
                                                    id="bank_name" value="{{$helper->bank_name}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="ifsc_code"
                                                    id="ifsc_code" value="{{$helper->ifsc_code}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="account_number"
                                                    id="bank_ac_no" value="{{$helper->account_number}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('date_of_birth', $helper->date_of_birth ? \Carbon\Carbon::parse($helper->date_of_birth)->format('d-m-Y') : '') }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <label class="input-label mb-2 ms-1" for="present_address">Present
                                                    Address</label>
                                                <input type="text" class="form-control bg-white"
                                                    name="present_address" id="present_address" value="{{$helper->present_address}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <label class="input-label mb-2 ms-1" for="permanent_address">Permanent
                                                    Address</label>
                                                <input type="text" class="form-control bg-white"
                                                    name="permanent_address" id="permanent_address" value="{{$helper->permanent_address}}" readonly>
                                            </div>
                                        </div>
                                        @if ($helper->work_type != 'in-house' && $helper->work_type != '')
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="father_name"
                                                    id="guardian_name" value="{{$helper->father_name ?: $helper->mother_name }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <label class="input-label mb-2 ms-1" for="guardian_phone">Father/ Mother/
                                                    Guardian Contact No</label>
                                                <input type="text" class="form-control bg-white" name="father_mobile_number"
                                                    id="guardian_phone" value="{{$helper->father_mobile_number ?: $helper->mother_mobile_number }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="referal_person_name"
                                                    id="referal_person_name" value="{{$helper->referal_person_name}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <label class="input-label mb-2 ms-1" for="reference_mobile">Reference
                                                    Contact No</label>
                                                <input type="text" class="form-control bg-white"
                                                    name="referal_person_number" id="referal_mobile" value="{{$helper->referal_person_number}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white"
                                                    ...
                                                    value="{{$helper->referal_person_relationship}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="spouse_name"
                                                    id="spouse_name" value="{{$helper->spouse_name}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="spouse_mobile_number"
                                                    id="spouse_mobile" value="{{$helper->spouse_mobile_number}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="blood_group"
                                                    id="blood_group" value="{{$helper->blood_group}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="social_links"
                                                    id="social_links" value="{{$helper->social_links}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control basic-single bg-white" id="rider_type" name="rider_type" disabled>
                                                    ...
                                                    <option value="{{ $riderType->id }}" {{ $helper->rider_type == $riderType->id ? 'selected' : '' }}>
                                                        {{ $riderType->type }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <!-- <select class="form-control basic-single bg-white" id="vehicle_type"
                                                    name="vehicle_type" value="{{$helper->rider_type}}" disabled>

                                                </select> -->
                                                <input type="text" class="form-control bg-white" name="vehicle_type"
                                                    id="vehicle_type" value="{{$helper->vehicle_type}}" readonly>
                                            </div>
                                        </div>
                                        {{-- @endif  --}}
                                    </div>
                                            ...
                                            <div class="col">
                                                ...
                                                <p class="mb-2 fw-medium">
                                                    ...
                                                    <span class="text-success">
                                                        {{ $helper->aadharVerifier->name ?? 'N/A' }}
                                                    </span>
                                                </p>

                                                <p class="fw-medium">Verified At:
                                                    <span class="text-success">
                                                        {{$helper->aadhar_verify_date}}
                                                    </span>
                                                </p>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-md-12 mt-3 mt-md-0 d-flex justify-content-center">
                                                <div class="col-md-12 mt-3 mt-md-0 d-flex justify-content-center">
                                                    <div class="image-container" >
                                                        <img src="{{ asset($helper->aadhar_card_front ? "/EV/images/aadhar/" . $helper->aadhar_card_front : "/EV/images/dummy.jpg") }}"
                                            ...
                                            <div class="col-12 mt-5">
                                                <button onclick="OpenImageModal('{{ asset($helper->aadhar_card_front ? "/EV/images/aadhar/" . $helper->aadhar_card_front : "/EV/images/dummy.jpg") }}')"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-md-12 mt-3 mt-md-0 d-flex justify-content-center">
                                                <div class="col-md-12 mt-3 mt-md-0 d-flex justify-content-center">
                                                    <div class="image-container" >
                                                        <img src="{{ asset($helper->aadhar_card_back ? "/EV/images/aadhar/" . $helper->aadhar_card_back : "/EV/images/dummy.jpg") }}"
                                                            class="preview-image img-fluid"
                                                            onerror="this.src='/EV/images/dummy.jpg'"
                                                            style="width: 350px; height: 230px; object-fit: cover; border-radius: 10px;">
                                                    </div>
                                            ...
                                            <div class="col-12 mt-5">
                                                <button onclick="OpenImageModal('{{ asset($helper->aadhar_card_back ? "/EV/images/aadhar/" . $helper->aadhar_card_back : "/EV/images/dummy.jpg") }}')"
                                                    class="btn btn-md border-gray w-100 d-flex align-items-center justify-content-center">
                                                    <i class="bi bi-eye fs-5 me-2"></i> View
                                                </button>
                                            </div>
                                ...
                                <div class="card mb-3 shadow shadow-md">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-md-12 mt-3 mt-md-0 d-flex justify-content-center">
                                                <div class="image-container" >
                                                    <img src="{{ asset($helper->pan_card_front ? "/EV/images/pan/" . $helper->pan_card_front : "/EV/images/dummy.jpg") }}"
                                                        class="preview-image img-fluid"
                                                        onerror="this.src='/EV/images/dummy.jpg'"
                                                        style="width: 350px; height: 230px; object-fit: cover; border-radius: 10px;">
                                                </div>
                                            ...
                                            <div class="col-12 mt-5">
                                                <button onclick="OpenImageModal('{{ asset($helper->pan_card_front ? "/EV/images/pan/" . $helper->pan_card_front : "/EV/images/dummy.jpg") }}')"
                                                    class="btn btn-md border-gray w-100 d-flex align-items-center justify-content-center">
                                                    <i class="bi bi-eye fs-5 me-2"></i> View
                                                </button>
                                            </div>
                                        ...
                                        <div class="row d-flex justify-content-between g-3">
                                            <div class="col">
                                                ...
                                                <p class="mb-2 fw-medium">
                                                    Verified by:
                                                    <span class="text-success">
                                                        {{ $helper->bankVerifier->name ?? 'N/A'  }}
                                                    </span>
                                                </p>

                                                <p class="fw-medium">Verified At:
                                                    <span class="text-success">
                                                        {{$helper->bank_verify_date}}
                                                    </span>
                                                </p>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-md-4 mt-3 mt-md-0 d-flex justify-content-start">
                                                <div class="col-md-12 mt-3 mt-md-0 d-flex justify-content-center">
                                                    <div class="image-container" >
                                                        <img src="{{ asset($helper->bank_passbook ? "/EV/images/bank_passbook/" . $helper->bank_passbook : "/EV/images/dummy.jpg") }}"
                                                            class="preview-image img-fluid"
                                                            onerror="this.src='/EV/images/dummy.jpg'"
                                                            style="width: 350px; height: 230px; object-fit: cover; border-radius: 10px;">
                                                    </div>
                                            ...
                                            <div class="col-md-6 mt-3 mt-md-0">
                                                <h6 class="my-3"> Bank Holder Name: {{$helper->account_holder_name}} <span
                                                        class="text-secondary"></span>
                                                </h6>
                                                <h6 class="mb-3"> Bank Name: {{$helper->bank_name}} <span class="text-secondary"></span>
                                                </h6>
                                                <h6 class="mb-3"> IFSC Code: {{$helper->isfc_code}} <span class="text-secondary"></span>
                                                </h6>
                                                <h6 class="mb-3"> Account Number:{{$helper->account_number }}  <span
                                                        class="text-secondary"></span>
                                                </h6>
                                            </div>

                                            <div class="col-12 mt-5">
                                                <button onclick="OpenImageModal('{{ asset($helper->bank_passbook ? "/EV/images/bank_passbook/" . $helper->bank_passbook : "/EV/images/dummy.jpg") }}')"
                                                    class="btn btn-md border-gray w-100 d-flex align-items-center justify-content-center">
                                                    <i class="bi bi-eye fs-5 me-2"></i> View
                                                </button>
                                            </div>
