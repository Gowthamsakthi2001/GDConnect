                ...
                <div class="row d-flex justify-content-between align-items-center flex-nowrap">
                        ...
                        <div class="d-flex justify-content-start align-items-center">
                            <div>
                                ...
                                <div class="col-12 text-center my-3">
                                    ...
                                    $photoFile = public_path('EV/images/photos/' . $rider->photo);
                                    $profileImage = (!empty($rider->photo) && file_exists($photoFile))
                                    ? asset('EV/images/photos/' . $rider->photo)
                                    : $defaultProfile;
                                    @endphp
                    ...
                    <div class="col-auto">
                        ...
                        <div class="d-flex justify-content-end align-items-center gap-2 flex-nowrap">
                            ...
                            <a href="{{ route('admin.Green-Drive-Ev.employee_categories.rider_list') }}"
                    ...
                    <div class="tab-pane fade show active" id="pills-basic-information" role="tabpanel"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body custom-card-body">
                                <form id="employeeForm" method="POST" action="{{ route('admin.Green-Drive-Ev.employee_categories.rider_update', $rider->id) }}">
                                    @csrf
                                    @method('POST')
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" class="form-control bg-white" name="mobile_number"
                                                    ...
                                                    value="{{$rider->mobile_number}}" readonly>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="first_name"
                                                    id="f_name" value="{{$rider->first_name}} " readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="last_name"
                                                    id="l_name" value="{{$rider->last_name}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="email"
                                                    id="email" value="{{$rider->email}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="gender"
                                                    id="gender" value="{{$rider->gender}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="house_no"
                                                    id="house_no" value="{{$rider->house_no}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="street_name"
                                                    id="street_name" value="{{$rider->street_name}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control basic-single bg-white" id="current_city_id" name="current_city_id" disabled>
                                                    ...
                                                    <option value="{{ $city->id }}" {{ $rider->current_city_id == $city->id ? 'selected' : '' }}>
                                                        {{ $city->city_name }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group mt-3">
                                                ...
                                                <select class="form-control basic-single bg-white" id="interested_city_id" name="interested_city_id" disabled>
                                                    @foreach($cities as $city)
                                                    <option value="{{ $city->id }}" {{ $rider->interested_city_id == $city->id ? 'selected' : '' }}>
                                                        {{ $city->city_name }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="pincode"
                                                    id="pincode" value="{{$rider->pincode}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white"
                                                    name="alternative_number" id="alternative_number" value="{{$rider->alternative_number}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <!-- <select class="form-control basic-single bg-white" id="role"
                                                  ...
                                                  <input type="text" class="form-control bg-white"
                                                    name="alternative_number" id="alternative_number" value="{{$rider->work_type}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="account_holder_name"
                                                    id="ac_holder_name" value="{{$rider-> account_holder_name}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="bank_name"
                                                    id="bank_name" value="{{$rider->bank_name}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="ifsc_code"
                                                    id="ifsc_code" value="{{$rider->ifsc_code}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="account_number"
                                                    id="bank_ac_no" value="{{$rider->account_number}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="date_of_birth"
                                                    id="d_o_b" value="{{$rider->date_of_birth}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <label class="input-label mb-2 ms-1" for="present_address">Present
                                                    Address</label>
                                                <input type="text" class="form-control bg-white"
                                                    name="present_address" id="present_address" value="{{$rider->present_address}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <label class="input-label mb-2 ms-1" for="permanent_address">Permanent
                                                    Address</label>
                                                <input type="text" class="form-control bg-white"
                                                    name="permanent_address" id="permanent_address" value="{{$rider->permanent_address}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="prev_rider_id"
                                                    id="prev_rider_id" value="" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <label class="input-label mb-2 ms-1" for="prev_company_experience">Past
                                                    Experience</label>
                                                <input type="text" class="form-control bg-white"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="father_name"
                                                    id="guardian_name" value="{{$rider->father_name ?: $rider->mother_name }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="guardian_phone"
                                                    id="guardian_phone" value="{{$rider->father_mobile_number ?: $rider->mother_mobile_number }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="referal_person_name"
                                                    id="reference_name" value="{{$rider->referal_person_name}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <label class="input-label mb-2 ms-1" for="reference_mobile">Reference
                                                    Contact No</label>
                                                <input type="text" class="form-control bg-white"
                                                    name="reference_mobile" id="referal_person_mobile" value="{{$rider->referal_person_number}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white"
                                                    ...
                                                    value="{{$rider->referal_person_relationship}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="spouse_name"
                                                    id="spouse_name" value="{{$rider->spouse_name}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="spouse_mobile_number"
                                                    id="spouse_mobile" value="{{$rider->spouse_mobile_number}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="blood_group"
                                                    id="blood_group" value="{{$rider->blood_group}}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="social_links"
                                                    id="social_links" value="{{$rider->social_links}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control basic-single bg-white" id="rider_type" name="rider_type" disabled>
                                                    ...
                                                    <option value="{{ $riderType->id }}" {{ $rider->rider_type == $riderType->id ? 'selected' : '' }}>
                                                        {{ $riderType->type }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <!-- <select class="form-control basic-single bg-white" id="vehicle_type"
                                                    name="vehicle_type" disabled> -->
                                                <input type="text" class="form-control bg-white" name="vehicle_type"
                                                    id="vehicle_type" value="{{$rider->vehicle_type}}" readonly>
                    ...
                    <div class="tab-pane fade" id="pills-kyc-doc" role="tabpanel"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body custom-card-body">
                                            ...
                                            <div class="col">
                                                ...
                                                <p class="mb-2 fw-medium">
                                                    ...
                                                    <span class="text-success">
                                                        {{$rider->aadharVerifier->name ?? 'N/A'}}
                                                    </span>
                                                </p>

                                                <p class="fw-medium">Verified At:
                                                    <span class="text-success">
                                                        {{$rider->aadhar_verify_date}}
                                                    </span>
                                                </p>
                                            </div>
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-md-12 mt-3 mt-md-0 d-flex justify-content-center">
                                                <div class="image-container" >
                                                    <img src="{{ asset($rider->aadhar_card_front ? "/EV/images/aadhar/" . $rider->aadhar_card_front : "/EV/images/dummy.jpg") }}"
                                            ...
                                            <div class="col-12 mt-5">
                                                <button onclick="OpenImageModal('{{ asset($rider->aadhar_card_front ? "/EV/images/aadhar/" . $rider->aadhar_card_front : "/EV/images/dummy.jpg") }}')"
                                ...
                                <div class="card mb-3 shadow shadow-md">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-md-12 mt-3 mt-md-0 d-flex justify-content-center">
                                                <div class="image-container" >
                                                    <img src="{{ asset($rider->aadhar_card_back ? "/EV/images/aadhar/" . $rider->aadhar_card_back : "/EV/images/dummy.jpg") }}"
                                                        class="preview-image img-fluid"
                                                        onerror="this.src='/EV/images/dummy.jpg'"
                                                        style="width: 350px; height: 230px; object-fit: cover; border-radius: 10px;">
                                                </div>
                                            ...
                                            <div class="col-12 mt-5">
                                                <button onclick="OpenImageModal('{{ asset($rider->aadhar_card_back ? "/EV/images/aadhar/" . $rider->aadhar_card_back : "/EV/images/dummy.jpg") }}')"
                                                    class="btn btn-md border-gray w-100 d-flex align-items-center justify-content-center">
                                                    <i class="bi bi-eye fs-5 me-2"></i> View
                                                </button>
                                            </div>
                                ...
                                {{-- CASE 1: Show LLR card if llr_image exists --}}
                                @if(!empty($rider->llr_image))
                                <div class="card mb-3 shadow shadow-md">
                                    <div class="card-header">
                                        <div class="row d-flex justify-content-between g-3">
                                            <div class="col">
                                                <div class="card-title h5 fw-medium">Learner's License (LLR)</div>
                                                <div class="card-title text-muted mb-3">Uploaded at {{ $rider->llr_upload_date ?? 'N/A' }}</div>
                                                <p class="mb-2 fw-medium">Verified by:
                                                    <span class="text-success">{{ $rider->licenseVerifier->name ?? 'N/A' }}</span>
                                                </p>
                                                <p class="fw-medium">Verified At:
                                                    <span class="text-success">{{ $rider->lisence_verify_date ?? 'N/A' }}</span>
                                                </p>
                                            </div>
                                            <div class="col text-end">
                                                <button class="btn btn-danger px-4"
                                                    onclick="status_change_alert('#', 'Verify this LLR?', event)">Verify</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="row mt-5">
                                            <div class="col-md-12 mt-3 mt-md-0 d-flex justify-content-center">
                                                <div class="image-container" >
                                                    <img src="{{ asset($rider->llr_image ? "/EV/images/llr_images/" . $rider->llr_image : "/EV/images/dummy.jpg") }}"
                                                        class="preview-image img-fluid"
                                                        onerror="this.src='/EV/images/dummy.jpg'"
                                                        style="width: 350px; height: 230px; object-fit: cover; border-radius: 10px;">
                                                </div>
                                            ...
                                            <div class="col-12 mt-5">
                                                <button onclick="OpenImageModal('{{ asset($rider->llr_image ? "/EV/images/llr_images/" . $rider->llr_image : "/EV/images/dummy.jpg") }}')" class="btn btn-md border-gray w-100 d-flex align-items-center justify-content-center">
                                                    <i class="bi bi-eye fs-5 me-2"></i> View
                                                </button>
                                            </div>
                                        </div>
                                ...
                                {{-- CASE 2: DL Front or Back exists --}}
                                @elseif(!empty($rider->driving_license_front) || !empty($rider->driving_license_back))
                                {{-- DL FRONT --}}
                                <div class="card mb-3 shadow shadow-md">
                                    <div class="card-header">
                                        <div class="row d-flex justify-content-between g-3">
                                            <div class="col">
                                                ...
                                                <div class="card-title text-muted mb-3">Uploaded at {{ $rider->dl_upload_date ?? 'N/A' }}</div>
                                                <p class="mb-2 fw-medium">Verified by:
                                                    <span class="text-success">{{ $rider->licenseVerifier->name ?? 'N/A' }}</span>
                                                </p>
                                                <p class="fw-medium">Verified At:
                                            ...
                                            <div class="col text-end">
                                                <button class="btn btn-danger px-4"
                                                    onclick="status_change_alert('#', 'Verify DL Front?', event)">Verify</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="row mt-5">
                                            <div class="col-md-12 mt-3 mt-md-0 d-flex justify-content-center">
                                                <div class="image-container" >
                                                    <img src="{{ asset($rider->driving_license_front ? "/EV/images/driving_license/" . $rider->driving_license_front : "/EV/images/dummy.jpg") }}"
                                                        class="preview-image img-fluid"
                                                        onerror="this.src='/EV/images/dummy.jpg'"
                                                        style="width: 350px; height: 230px; object-fit: cover; border-radius: 10px;">
                                                </div>
                                            ...
                                            <div class="col-12 mt-5">
                                                <button onclick="OpenImageModal('{{ asset($rider->driving_license_front ? "/EV/images/driving_license/" . $rider->driving_license_front : "/EV/images/dummy.jpg") }}')" class="btn btn-md border-gray w-100 d-flex align-items-center justify-content-center">
                                                    <i class="bi bi-eye fs-5 me-2"></i> View
                                                </button>
                                            </div>
                                        </div>
                                ...
                                {{-- DL BACK --}}
                                @if(!empty($rider->driving_license_back))
                                <div class="card mb-3 shadow shadow-md">
                                    <div class="card-header">
                                        <div class="row d-flex justify-content-between g-3">
                                            <div class="col">
                                                <div class="card-title h5 fw-medium">Driving License Back</div>
                                                <div class="card-title text-muted mb-3">Uploaded at Uploaded at 24 ar 2025,
                                                    12:30:00 AM</div>
                                                <p class="mb-2 fw-medium">Verified by:
                                                    <span class="text-success">{{ $rider->licenseVerifier->name ?? 'N/A' }}</span>
                                                </p>
                                            ...
                                            <div class="col text-end">
                                                <button class="btn btn-danger px-4"
                                                    onclick="status_change_alert('#', 'Verify DL Back?', event)">Verify</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="row mt-5">
                                            <div class="col-md-12 mt-3 mt-md-0 d-flex justify-content-center">
                                                <div class="image-container" >
                                                    <img src="{{ asset($rider->driving_license_back ? "/EV/images/driving_license/" . $rider->driving_license_back : "/EV/images/dummy.jpg") }}"
                                                        class="preview-image img-fluid"
                                                        onerror="this.src='/EV/images/dummy.jpg'"
                                                        style="width: 350px; height: 230px; object-fit: cover; border-radius: 10px;">
                                                </div>
                                            ...
                                            <div class="col-12 mt-5">
                                                <button onclick="OpenImageModal('{{ asset($rider->driving_license_back ? "/EV/images/driving_license/" . $rider->driving_license_back : "/EV/images/dummy.jpg") }}')" class="btn btn-md border-gray w-100 d-flex align-items-center justify-content-center">
                                                    <i class="bi bi-eye fs-5 me-2"></i> View
                                                </button>
                                            </div>
                                        </div>
                                ...
                                {{-- CASE 3: Everything is empty — show dummy DL cards --}}
                                @else
                                {{-- DL FRONT (dummy) --}}
                                <div class="card mb-3 shadow shadow-md">
                                    <div class="card-header">
                                        <div class="row d-flex justify-content-between g-3">
                                            <div class="col">
                                                ...
                                                <div class="card-title text-muted mb-3">Uploaded at 24 ar 2025,
                                                    12:30:00 AM</div>
                                                <p class="mb-2 fw-medium">Verified by: <span class="text-success">N/A</span></p>
                                                <p class="fw-medium">Verified At: <span class="text-success">N/A</span></p>
                                            </div>
                                            <div class="col text-end">
                                                <button class="btn btn-danger px-4"
                                                    onclick="status_change_alert('#', 'Verify DL Front?', event)">Verify</button>
                                    ...
                                    <div class="card-body d-flex justify-content-center">
                                        <img src="/EV/images/dummy.jpg" class="img-fluid"
                                            style="width: 350px; height: 230px; object-fit: cover; border-radius: 10px;">
                                    </div>
                                </div>
                                ...
                                <div class="card mb-3 shadow shadow-md">
                                        ...
                                        <div class="row d-flex justify-content-between g-3">
                                            <div class="col">
                                                ...
                                                <p class="mb-2 fw-medium">
                                                    Verified by:
                                                    <span class="text-success">
                                                        {{$rider->panVerifier->name ?? 'N/A'}}
                                                    </span>
                                                </p>

                                                <p class="fw-medium">Verified At:
                                                    <span class="text-success">
                                                        {{$rider->pan_verify_date}}
                                                    </span>
                                                </p>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-md-12 mt-3 mt-md-0 d-flex justify-content-center">
                                                <div class="image-container" >
                                                    <img src="{{ asset($rider->pan_card_front ? "/EV/images/pan/" . $rider->pan_card_front : "/EV/images/dummy.jpg") }}"
                                                        class="preview-image img-fluid"
                                                        onerror="this.src='/EV/images/dummy.jpg'"
                                                        style="width: 350px; height: 230px; object-fit: cover; border-radius: 10px;">
                                                </div>
                                            ...
                                            <div class="col-12 mt-5">
                                                <button onclick="OpenImageModal('{{ asset($rider->pan_card_front ? "/EV/images/pan/" . $rider->pan_card_front : "/EV/images/dummy.jpg") }}')"
                                                    class="btn btn-md border-gray w-100 d-flex align-items-center justify-content-center">
                                                    <i class="bi bi-eye fs-5 me-2"></i> View
                                                </button>
                                            </div>
                                        ...
                                        <div class="row d-flex justify-content-between g-3">
                                            <div class="col">
                                                ...
                                                <p class="mb-2 fw-medium">
                                                    Verified by:
                                                    <span class="text-success">
                                                        {{$rider->bankVerifier->name ?? 'N/A'}}
                                                    </span>
                                                </p>

                                                <p class="fw-medium">Verified At:
                                                    <span class="text-success">
                                                        {{$rider->bank_verify_date}}
                                                    </span>
                                                </p>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-md-4 mt-3 mt-md-0 d-flex justify-content-start">
                                                <div class="image-container" >
                                                    <img src="{{ asset($rider->bank_passbook ? "/EV/images/bank_passbook/" . $rider->bank_passbook : "/EV/images/dummy.jpg") }}"
                                                        class="preview-image img-fluid"
                                                        onerror="this.src='/EV/images/dummy.jpg'"
                                                        style="width: 350px; height: 230px; object-fit: cover; border-radius: 10px;">
                                                </div>
                                            ...
                                            <div class="col-md-6 mt-3 mt-md-0">
                                                <h6 class="my-3"> Bank Holder Name: {{$rider->account_holder_name}} <span
                                                        class="text-secondary"></span>
                                                </h6>
                                                <h6 class="mb-3"> Bank Name:  {{$rider->bank_name}}<span class="text-secondary"></span>
                                                </h6>
                                                <h6 class="mb-3"> IFSC Code: {{$rider->ifsc_code}} <span class="text-secondary"></span>
                                                </h6>
                                                <h6 class="mb-3"> Account Number:{{$rider->account_number}}  <span
                                                        class="text-secondary"></span>
                                                </h6>
                                            </div>

                                            <div class="col-12 mt-5">
                                                <button onclick="OpenImageModal('{{ asset($rider->bank_passbook ? "/EV/images/bank_passbook/" . $rider->bank_passbook : "/EV/images/dummy.jpg") }}')"
                                                    class="btn btn-md border-gray w-100 d-flex align-items-center justify-content-center">
                                                    <i class="bi bi-eye fs-5 me-2"></i> View
                                                </button>
                                            </div>
    ...
    <div class="modal-content rounded-4">
      ...
      <div class="modal-body text-center py-6" style="overflow: auto; max-height: 80vh;">
        ...
        <script>
            ...
            function edit_candidate() {
                $(".edit-candidate-btn").addClass("d-none").removeClass("d-block");
                $(".update-candidate").addClass("d-block").removeClass("d-none");
                $("input").attr("readonly", false);
                $("select").attr("disabled", false);
            }

            // Add this to handle cancel button
            function cancel_edit() {
                $(".update-candidate").addClass("d-none").removeClass("d-block");
                $(".edit-candidate-btn").addClass("d-block").removeClass("d-none");
                $("input").attr("readonly", true);
                $("select").attr("disabled", true);
                // Optionally reload the page to reset changes
                location.reload();
            }
        </script>
