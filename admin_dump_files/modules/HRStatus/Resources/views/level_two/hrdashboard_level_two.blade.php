     ...
     <div class="card bg-transparent my-4">
                <div class="card-header" style="background:#fbfbfb;">
                    <div class="row g-3">
                       <div class="col-md-6 d-flex align-items-center">
                            <div class="card-title h4 fw-bold">HR Level 02 Dashboard</div>
                        </div>
        ...
        <div class="row" id="HRL01_summaryCardBody">
            <div class="col-md-4 col-6 mb-4 summary-card">
                <a class="text-dark" href="{{route('admin.Green-Drive-Ev.hr_level_two.app_list',['type'=>'total_application'])}}">
                    <div class="card border-0 equal-card shadow-secondary">
                        <div class="bg-white rounded-lg p-3 p-md-3 p-lg-3 p-xl-4">
                            <div>
                                ...
                                <div class="my-4">
                                    <h4 class="mb-0"><span style="color: #4b5563;" class="pe-2" id="totalApplications"> {{$totalcount ?? 0}} </span> <img
                                            src="{{ asset('admin-assets/icons/custom/Trending_down.png') }}"
                                            class="img-fluid"></h4>
                                </div>
            
                                <div class="mb-3">
                                    <p class="text-muted">Shows All applications forwarded from HR1 / BGV</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-4 col-6 mb-4 summary-card">
                <a class="text-dark" href="{{route('admin.Green-Drive-Ev.hr_level_two.app_list',['type'=>'pending'])}}">
                    <div class="card border-0 equal-card shadow-secondary">
                        <div class="bg-white rounded-lg p-3 p-md-3 p-lg-3 p-xl-4">
                            <div>
                                <div class="d-flex justify-content-between align-items-start my-3">
                                    <h5 class="ps-2 mb-0" style="border-left: 4px solid #12ae3a;" ><span style="color:#4b5563;">Pending Final Approval </span></h5>
                                    <img src="{{ asset('admin-assets/icons/custom/arrow.png') }}" class="img-fluid">
                                </div>
                                <div class="my-4">
                                    <h4 class="mb-0"><span style="color: #4b5563;" class="pe-2" id="pendingApplications"> {{$pending ?? 0}} </span> <img
                                            src="{{ asset('admin-assets/icons/custom/Down_Icon.png') }}"
                                            class="img-fluid"></h4>
                                </div>
            {{-- ('../../public/admin-assets/icons/custom/Down_Icon.png') --}}
                                <div class="mb-3">
                                    <p class="text-muted">Shows Applications waiting for final HR2 decision</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-4 col-6 mb-4 summary-card">
                <a class="text-dark" href="{{route('admin.Green-Drive-Ev.hr_level_two.app_list',['type'=>'sent_to_bgv'])}}">
                    <div class="card border-0 equal-card shadow-secondary">
                        <div class="bg-white rounded-lg p-3 p-md-3 p-lg-3 p-xl-4">
                            <div>
                                <div class="d-flex justify-content-between align-items-start my-3">
                                    <h5 class="ps-2 mb-0" style="border-left: 4px solid #1661c7;"><span style="color:#4b5563;">Sent Back to BGV</span></h5>
                                    <img src="{{ asset('admin-assets/icons/custom/arrow.png') }}" class="img-fluid">
                                </div>
                                <div class="my-4">
                                    <h4 class="mb-0"><span style="color: #4b5563;" class="pe-2" id="bgvApplications"> {{$sentToBGV ?? 0}} </span> <img
                                            src="{{ asset('admin-assets/icons/custom/Trending_down.png') }}"
                                            class="img-fluid"></h4>
                                </div>
            
                                <div class="mb-3">
                                    <p class="text-muted">Shows applications returned for re-verification</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-4 col-6 mb-4 summary-card">
                <a class="text-dark" href="{{route('admin.Green-Drive-Ev.hr_level_two.app_list',['type'=>'sent_to_hr1'])}}">
                    <div class="card border-0 equal-card shadow-secondary">
                        <div class="bg-white rounded-lg p-3 p-md-3 p-lg-3 p-xl-4">
                            <div>
                                <div class="d-flex justify-content-between align-items-start my-3">
                                    <h5 class="ps-2 mb-0" style="border-left: 4px solid #efd27b;"><span style="color:#4b5563;">Sent Back to HR1 </span></h5>
                                    <img src="{{ asset('admin-assets/icons/custom/arrow.png') }}" class="img-fluid">
                                </div>
                                <div class="my-4">
                                    <h4 class="mb-0"><span style="color: #4b5563;" class="pe-2" id="hr1Applications"> {{$sentToHR1 ?? 0}} </span> <img
                                            src="{{ asset('admin-assets/icons/custom/Trending_down.png') }}"
                                            class="img-fluid"></h4>
                                </div>
            
                                <div class="mb-3">
                                    <p class="text-muted">Shows applications returned for additional review</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-4 col-6 mb-4 summary-card">
                <a class="text-dark" href="{{route('admin.Green-Drive-Ev.hr_level_two.app_list',['type'=>'approved_employee'])}}">
                    <div class="card border-0 equal-card shadow-secondary">
                        <div class="bg-white rounded-lg p-3 p-md-3 p-lg-3 p-xl-4">
                            <div>
                                <div class="d-flex justify-content-between align-items-start my-3">
                                    <h5 class="ps-2 mb-0" style="border-left: 4px solid #947bef;"><span style="color:#4b5563;">Approved - Employees</span></h5>
                                    <img src="{{ asset('admin-assets/icons/custom/arrow.png') }}" class="img-fluid">
                                </div>
                                <div class="my-4">
                                    <h4 class="mb-0"><span style="color: #4b5563;" class="pe-2" id="approvedEmp"> {{$approvedEmp ?? 0}} </span> <img
                                            src="{{ asset('admin-assets/icons/custom/Trending_down.png') }}"
                                            class="img-fluid"></h4>
                                </div>
            
                                <div class="mb-3">
                                    <p class="text-muted">Shows Final approved with employee ID generated</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-4 col-6 mb-4 summary-card">
                <a class="text-dark" href="{{route('admin.Green-Drive-Ev.hr_level_two.app_list',['type'=>'approved_rider'])}}">
                    <div class="card border-0 equal-card shadow-secondary">
                        <div class="bg-white rounded-lg p-3 p-md-3 p-lg-3 p-xl-4">
                            <div>
                                <div class="d-flex justify-content-between align-items-start my-3">
                                    <h5 class="ps-2 mb-0" style="border-left: 4px solid #d79232;"><span style="color:#4b5563;">Approved - Riders</span></h5>
                                    <img src="{{ asset('admin-assets/icons/custom/arrow.png') }}" class="img-fluid">
                                </div>
                                <div class="my-4">
                                    <h4 class="mb-0"><span style="color: #4b5563;" class="pe-2" id="approvedRider"> {{$approvedRider ?? 0}} </span> <img
                                        src="{{ asset('admin-assets/icons/custom/Trending_down.png') }}"
                                        class="img-fluid"></h4>
                                </div>
                                <div class="mb-3">
                                    <p class="text-muted">Final approved and moved to probation/training</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            {{-- <div class="col-md-4 col-6 mb-4 summary-card">
                <a class="text-dark" href="{{route('admin.Green-Drive-Ev.hr_level_two.app_list',['type'=>'on_hold'])}}">
                    <div class="card border-0 equal-card shadow-secondary">
                        <div class="bg-white rounded-lg p-3 p-md-3 p-lg-3 p-xl-4">
                            <div>
                                <div class="d-flex justify-content-between align-items-start my-3">
                                    <h5 class="ps-2 mb-0" style="border-left: 4px solid #d165e1;"><span style="color:#4b5563;">Approved - Employees</span></h5>
                                    <img src="{{ asset('admin-assets/icons/custom/arrow.png') }}" class="img-fluid">
                                </div>
                                <div class="my-4">
            ...
            <div class="col-md-4 col-6 mb-4 summary-card">
                <a class="text-dark" href="{{route('admin.Green-Drive-Ev.hr_level_two.app_list',['type'=>'reject_by_hr2'])}}">
                    <div class="card border-0 equal-card shadow-secondary">
                        <div class="bg-white rounded-lg p-3 p-md-3 p-lg-3 p-xl-4">
                            <div>
                                <div class="d-flex justify-content-between align-items-start my-3">
                                    <h5 class="ps-2 mb-0" style="border-left: 4px solid #866518;"><span style="color:#4b5563;">Rejected by HR2</span></h5>
                                    <img src="{{ asset('admin-assets/icons/custom/arrow.png') }}" class="img-fluid">
                                </div>
                                <div class="my-4">
                                    <h4 class="mb-0"><span style="color: #4b5563;" class="pe-2" id="rejectedApplications"> {{$rejected ?? 0}} </span> <img
                                            src="{{ asset('admin-assets/icons/custom/Down_Icon.png') }}"
                                            class="img-fluid"></h4>
                                </div>
            
                                <div class="mb-3">
                                    <p class="text-muted">Shows rejected at final stage</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            {{-- <div class="col-md-4 col-6 mb-4 summary-card">
                <a class="text-dark" href="{{route('admin.Green-Drive-Ev.hr_level_two.app_list',['type'=>'hr02_approved_employees'])}}">
                    <div class="card border-0 equal-card shadow-secondary">
                        <div class="bg-white rounded-lg p-3 p-md-3 p-lg-3 p-xl-4">
                            <div>
                                <div class="d-flex justify-content-between align-items-start my-3">
       ...
       <div class="offcanvas offcanvas-end" tabindex="-1" id="DashoffcanvasRightHR01" aria-labelledby="DashoffcanvasRightHR01Label">
          <div class="offcanvas-header">
            <h5 class="custom-dark" id="DashoffcanvasRightHR01Label">HR Level 02 Filters</h5>
...
document.addEventListener('DOMContentLoaded', function () {
    const clearBtn = document.querySelector('#DashoffcanvasRightHR01 .btn-outline-secondary');

    clearBtn.addEventListener('click', function () {
        // 1️⃣ Clear all radio buttons
        document.querySelectorAll('#DashoffcanvasRightHR01 input[type="radio"]').forEach(el => {
            el.checked = false;
        });

        // 2️⃣ Clear all dates
        document.querySelectorAll('#DashoffcanvasRightHR01 input[type="date"]').forEach(el => {
            el.value = '';
        });
    });
});
    ...
    const role = $('input[name="roleTypebtn"]:checked').next('label').text().trim();
    const from_date = $('#FromDate').val();
    const to_date = $('#ToDate').val();

    $.ajax({
       url: '{{ route("admin.Green-Drive-Ev.hr_level_two.admin.hr-filtered-stats") }}',
        method: 'POST',
        data: {
            _token: '{{ csrf_token() }}',
            role: role,
        ...
        success: function (res) {
            // Update card values
            $('#totalApplications').text(res.total);
            $('#pendingApplications').text(res.pending);
            $('#bgvApplications').text(res.sent_to_bgv);
            $('#hr1Applications').text(res.sent_to_hr1);
            $('#approvedEmp').text(res.approved_employee);
            $('#approvedRider').text(res.approved_rider);
            $('#rejectedApplications').text(res.rejected);

            // Hide offcanvas if needed
            $('#DashoffcanvasRightHR01').offcanvas('hide');
        },
        error: function (err) {
            console.error(err);
        }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Apply filter with time period support
    $('#applyFilterBtn').on('click', function () {
        const role = $('input[name="roleTypebtn"]:checked').next('label').text().trim();
        const from_date = $('#FromDate').val();
        const to_date = $('#ToDate').val();
        ...
        // Check which time period is selected
        const selectedTimeline = document.querySelector('input[name="STtimeLine"]:checked');
        if (selectedTimeline) {
            time_period = selectedTimeline.id.replace('timeLine', ''); // Get 1, 2, 3, or 4
        }

        // Validate date range if dates are provided
        if (from_date || to_date) {
            if (!from_date || !to_date) {
                toastr.error("Both From Date and To Date are required when using date range");
                return;
            }
        }
        ...
        $.ajax({
            ...
            data: {
                ...
                from_date: from_date,
                to_date: to_date,
                timeline: time_period // Changed from time_period to timeline to match reference
            },
            success: function (res) {
                $('#totalApplications').text(res.total);
                $('#pendingApplications').text(res.pending);
            ...
            error: function (err) {
                console.error(err);
                toastr.error("Failed to apply filters. Please try again.");
            }
        });
    });

    // Auto-set date range when timeline is selected
    $('.select_time_line').on('change', function() {
        const timeline = $(this).attr('id');
        let fromDate = '';
        let toDate = new Date().toISOString().split('T')[0]; // Today as default end date
        
        // Clear any existing dates
        $('#FromDate').val('');
        $('#ToDate').val('');
        
        // Calculate dates based on selected timeline
        const today = new Date();
        switch(timeline) {
            case 'timeLine1': // This day
                fromDate = toDate;
                break;
            case 'timeLine2': // This week
                const firstDayOfWeek = new Date(today.setDate(today.getDate() - today.getDay()));
                fromDate = firstDayOfWeek.toISOString().split('T')[0];
                break;
            case 'timeLine3': // This month
                const firstDayOfMonth = new Date(today.getFullYear(), today.getMonth(), 1);
                fromDate = firstDayOfMonth.toISOString().split('T')[0];
                break;
            case 'timeLine4': // This year
