                ...
                <div class="row d-flex justify-content-between align-items-center flex-nowrap">
                        ...
                        <div class="d-flex justify-content-start align-items-center">
                            <div>
                                ...
                                <div class="col-12 text-center my-3">
                                    ...
                                    $photoFile = public_path('EV/images/photos/' . $employee->photo);
                                    $profileImage = (!empty($employee->photo) && file_exists($photoFile))
                                    ? asset('EV/images/photos/' . $employee->photo)
                                    : $defaultProfile;
                                    @endphp
                    ...
                    <div class="col-auto">
                        ...
                        <div class="d-flex justify-content-end align-items-center gap-2 flex-nowrap">
                            ...
                            <a href="{{ route('admin.Green-Drive-Ev.employee_categories.employee_list') }}"
                    ...
                    <div class="tab-pane fade show active" id="pills-basic-information" role="tabpanel"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body custom-card-body">
                                <form id="employeeForm" method="POST" action="{{ route('admin.Green-Drive-Ev.employee_categories.employee_update', $employee->id) }}">
                                    @csrf
                                    @method('POST')
                                    <div class="row">
                                        ...
                                        <div class="col-12 text-center my-3">
                                            ...
                                            ? (file_exists(public_path('EV/images/photos/' . $employee->photo))
                                            ? asset('EV/images/photos/' . $employee->photo)
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="first_name"
                                                    id="f_name" value="{{$employee->first_name}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="last_name"
                                                    id="l_name" value="{{$employee->last_name}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="house_no"
                                                    id="house_no" value="{{$employee->house_no}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="street_name"
                                                    id="street_name" value="{{$employee->street_name}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control basic-single bg-white" id="current_city_id" name="current_city_id" disabled>
                                                    ...
                                                    <option value="{{ $city->id }}" {{ $employee->current_city_id == $city->id ? 'selected' : '' }}>
                                                        {{ $city->city_name }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group mt-3">
                                                ...
                                                <select class="form-control basic-single bg-white" id="interested_city_id" name="interested_city_id" disabled>
                                                    @foreach($cities as $city)
                                                    <option value="{{ $city->id }}" {{ $employee->interested_city_id == $city->id ? 'selected' : '' }}>
                                                        {{ $city->city_name }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="pincode"
                                                    id="pincode" value="{{$employee->pincode}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white"
                                                    name="alternative_number" id="alternative_number" value="{{$employee->alternative_number}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <label class="input-label mb-2 ms-1" for="role">Role</label>
                                                 <input type="text" class="form-control bg-white"
                                                    name="alternative_number" id="alternative_number" value="{{$employee->work_type}}">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="ac_holder_name"
                                                    id="ac_holder_name" value="{{$employee->account_holder_name}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="bank_name"
                                                    id="bank_name" value="{{$employee->bank_name}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="ifsc_code"
                                                    id="ifsc_code" value="{{$employee->ifsc_code}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="account_number"
                                                    id="bank_ac_no" value="{{ $employee->account_number ?? '' }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="date_of_birth"
                                                    id="d_o_b" value="{{ $employee->date_of_birth ? \Carbon\Carbon::parse($employee->d_o_b)->format('d-m-Y') : '' }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white"
                                                    name="present_address" id="present_address" value="{{ $employee->present_address ?? '' }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white"
                                                    name="permanent_address" id="permanent_address" value="{{ $employee->permanent_address ?? '' }}" readonly>
                                            </div>
                                        </div>

                                        @if ($employee->work_type != 'in-house' && $employee->work_type != '')
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <label class="input-label mb-2 ms-1" for="prev_rider_id">Previous Rider ID</label>
                                                <input type="text" class="form-control bg-white" name="prev_rider_id"
                                                    id="prev_rider_id" value="{{ $employee->prev_rider_id ?? '' }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white"
                                                    ...
                                                    value="{{ $employee->prev_company_experience ?? '' }}" readonly>
                                            </div>
                                        </div>
                                        @endif
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="father_name"
                                                    id="guardian_name" value="{{$employee->father_name ?: $employee->mother_name }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <label class="input-label mb-2 ms-1" for="guardian_phone">Father/Mother/Guardian Contact No</label>
                                                <input type="text" class="form-control bg-white" name="father_mobile_number"
                                                    id="guardian_phone" value="{{$employee->father_mobile_number ?: $employee->mother_mobile_number }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="referal_person_name"
                                                    id="reference_name" value="{{ $employee->referal_person_name ?? '' }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white"
                                                    name="referal_person_number" id="reference_mobile" value="{{ $employee->referal_person_number ?? '' }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white"
                                                    ...
                                                    value="{{ $employee->referal_person_relationship ?? '' }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="spouse_name"
                                                    id="spouse_name" value="{{ $employee->spouse_name ?? '' }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="spouse_mobile_number"
                                                    id="spouse_mobile" value="{{ $employee->spouse_mobile_number ?? '' }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="blood_group"
                                                    id="blood_group" value="{{ $employee->blood_group ?? '' }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control bg-white" name="social_links"
                                                    id="social_links" value="{{ $employee->social_links ?? '' }}" readonly>
                                            </div>
                                        </div>

                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <label class="input-label mb-2 ms-1" for="interested_city_id">Rider Type</label>
                                                <select class="form-control basic-single bg-white" id="rider_type" name="rider_type" disabled>
                                                    @foreach($riderTypes as $rider)
                                                    <option value="{{ $rider->id }}" {{ $employee->rider_type == $rider->id ? 'selected' : '' }}>
                                                        {{ $rider->type }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <!-- <select class="form-control basic-single bg-white" id="vehicle_type"
                                                    name="vehicle_type" value="{{$employee->vehicle_type}}" disabled>

                                                </select> -->

                                                <input type="text" class="form-control bg-white" name="vehicle_type"
                                                    id="vehicle_type" value="{{$employee->vehicle_type}}" readonly>
                                            </div>
                                        </div>
                                        {{-- @endif  --}}
                                    </div>
                                            ...
                                            <div class="col">
                                                ...
                                                <p class="mb-2 fw-medium">
                                                    ...
                                                    <span class="text-success">
                                                        {{ $employee->aadharVerifier->name ?? 'N/A' }}
                                                    </span>
                                                </p>

                                                <p class="fw-medium">Verified At:
                                                    <span class="text-success">
                                                        {{$employee->aadhar_verify_date}}
                                                    </span>
                                                </p>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-md-12 mt-3 mt-md-0 d-flex justify-content-center">
                                                <div class="col-md-12 mt-3 mt-md-0 d-flex justify-content-center">
                                                    <div class="image-container" >
                                                        <img src="{{ asset($employee->aadhar_card_front ? "/EV/images/aadhar/" . $employee->aadhar_card_front : "/EV/images/dummy.jpg")  }}"
                                            ...
                                            <div class="col-12 mt-5">
                                                <button onclick="OpenImageModal('{{ asset($employee->aadhar_card_front ? "/EV/images/aadhar/" . $employee->aadhar_card_front : "/EV/images/dummy.jpg") }}')"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-md-12 mt-3 mt-md-0 d-flex justify-content-center">
                                                <div class="col-md-12 mt-3 mt-md-0 d-flex justify-content-center">
                                                    <div class="image-container" >
                                                        <img src="{{ asset($employee->aadhar_card_back ? "/EV/images/aadhar/" . $employee->aadhar_card_back : "/EV/images/dummy.jpg")  }}"
                                                            class="preview-image img-fluid"
                                                            onerror="this.src='/EV/images/dummy.jpg'"
                                                            style="width: 350px; height: 230px; object-fit: cover; border-radius: 10px;">
                                                    </div>
                                            ...
                                            <div class="col-12 mt-5">
                                                <button onclick="OpenImageModal('{{ asset($employee->aadhar_card_back ? "/EV/images/aadhar/" . $employee->aadhar_card_back : "/EV/images/dummy.jpg")  }}')"
                                                    class="btn btn-md border-gray w-100 d-flex align-items-center justify-content-center">
                                                    <i class="bi bi-eye fs-5 me-2"></i> View
                                                </button>
                                            </div>
                                        ...
                                        <div class="row d-flex justify-content-between g-3">
                                            <div class="col">
                                                ...
                                                <p class="mb-2 fw-medium">
                                                    Verified by:
                                                    <span class="text-success">
                                                        {{ $employee->panVerifier->name ?? 'N/A' }}
                                                    </span>
                                                </p>

                                                <p class="fw-medium">Verified At:
                                                    <span class="text-success">
                                                        {{$employee->pan_verify_date}}
                                                    </span>
                                                </p>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-md-12 mt-3 mt-md-0 d-flex justify-content-center">
                                                <div class="col-md-12 mt-3 mt-md-0 d-flex justify-content-center">
                                                    <div class="image-container" >
                                                        <img src="{{ asset($employee->pan_card_front ? "/EV/images/pan/" . $employee->pan_card_front : "/EV/images/dummy.jpg")  }}"
                                                            class="preview-image img-fluid"
                                                            onerror="this.src='/EV/images/dummy.jpg'"
                                                            style="width: 350px; height: 230px; object-fit: cover; border-radius: 10px;">
                                                    </div>
                                            ...
                                            <div class="col-12 mt-5">
                                                <button onclick="OpenImageModal('{{ asset($employee->pan_card_front ? "/EV/images/pan/" . $employee->pan_card_front : "/EV/images/dummy.jpg")  }}')"
                                                    class="btn btn-md border-gray w-100 d-flex align-items-center justify-content-center">
                                                    <i class="bi bi-eye fs-5 me-2"></i> View
                                                </button>
                                            </div>
                                        ...
                                        <div class="row d-flex justify-content-between g-3">
                                            <div class="col">
                                                ...
                                                <p class="mb-2 fw-medium">
                                                    Verified by:
                                                    <span class="text-success">
                                                        {{ $employee->bankVerifier->name ?? 'N/A' }}
                                                    </span>
                                                </p>

                                                <p class="fw-medium">Verified At:
                                                    <span class="text-success">
                                                        {{$employee->bank_verify_date}}
                                                    </span>
                                                </p>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-md-4 mt-3 mt-md-0 d-flex justify-content-start">
                                                <div class="col-md-12 mt-3 mt-md-0 d-flex justify-content-center">
                                                    <div class="image-container" >
                                                        <img src="{{ asset($employee->bank_passbook ? "/EV/images/bank_passbook/" . $employee->bank_passbook : "/EV/images/dummy.jpg")  }}"
                                                            class="preview-image img-fluid"
                                                            onerror="this.src='/EV/images/dummy.jpg'"
                                                            style="width: 350px; height: 230px; object-fit: cover; border-radius: 10px;">
                                                    </div>
                                            ...
                                            <div class="col-md-6 mt-3 mt-md-0">
                                                <h6 class="my-3"> Bank Holder Name:{{$employee->account_holder_name}} <span
                                                        class="text-secondary"></span>
                                                </h6>
                                                <h6 class="mb-3"> Bank Name: {{$employee->bank_name}} <span class="text-secondary"></span>
                                                </h6>
                                                <h6 class="mb-3"> IFSC Code:{{$employee->ifsc_code}} <span class="text-secondary"></span>
                                                </h6>
                                                <h6 class="mb-3"> Account Number:{{$employee->account_number}}<span
                                                        class="text-secondary"></span>
                                                </h6>
                                            </div>

                                            <div class="col-12 mt-5">
                                                <button onclick="OpenImageModal('{{ asset($employee->bank_passbook ? "/EV/images/bank_passbook/" . $employee->bank_passbook : "/EV/images/dummy.jpg")  }}')"
                                                    class="btn btn-md border-gray w-100 d-flex align-items-center justify-content-center">
                                                    <i class="bi bi-eye fs-5 me-2"></i> View
                                                </button>
                                            </div>
