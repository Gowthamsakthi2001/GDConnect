                ...
                <div class="card-header" style="background:#fbfbfb;">
                    <div class="row g-3">
                        <div class="col-12 col-md-6 mb-2">
                            @if($type == "approved_riders")
                              <div class="card-title h4 fw-bold">Approved Candidates</div>
                            @elseif($type == "rejected_riders")
                              <div class="card-title h4 fw-bold">Rejected Candidates</div>
                            @elseif($type == "live_riders")
                              <div class="card-title h4 fw-bold">Live Candidates</div>
                             @elseif($type == "probation_riders")
                              <div class="card-title h4 fw-bold">Probation Candidates</div>
                            @else
                               <div class="card-title h4 fw-bold">Candidates</div>
                            @endif
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Recruiters</a></li>
                                    @if($type == "approved_riders")
                                      <li class="breadcrumb-item"><a href="javascript:void(0);">Approved Candidates</a></li>
                                    @elseif($type == "rejected_riders")
                                       <li class="breadcrumb-item"><a href="javascript:void(0);">Rejected Candidates</a></li>
                                    @elseif($type == "live_riders")
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Live Candidates</a></li>
                                    @elseif($type == "probation_riders")
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Probation Candidates</a></li>
                                    @else
                        ...
                        <div class="col-12">
                                ...
                                <div class="col-md-3 col-12 p-3 rounded d-flex align-items-center" style="background:#ffffff;">
                                    ...
                                    <div>
                                        ...
                                        <select class="form-select border-0 custom-select2-field" id="Fil_CityID"
                                            style="width:100%;" onchange="CitywiseFilter(this.value)">
                                ...
                                <div class="col-md-3 col-12 p-3 rounded d-flex align-items-center" style="background:#ffffff;">
                                    ...
                                    <div>
                                        ...
                                        <select class="form-select border-0 custom-select2-field" id="Fil_BGVStatus"
                                            style="width:100%;" onchange="BGVstatuswiseFilter(this.value)">
                            ...
                            <div class="row d-flex justify-content-end align-items-center mt-1">
                                <div class="col-md-3 col-12 rounded d-flex align-items-center" style="background:#ffffff;">
                                    <div class="me-2">
                                     ...
                                     <div>
                                        ...
                                        <select class="form-select border-0 custom-select2-field" onchange="RollTypeFiler(this.value)">
                                ...
                                <div class="col-md-3 col-12 p-3 rounded d-flex flex-column flex-sm-row align-items-center justify-content-end"
                                    style="background:#ffffff;">
                                    <button class="btn btn-dark me-2 px-4" onclick="DatewiseFiler()">Filter</button>
                                    <a href="javascript:void(0);" onclick="Resetoption()"
                            ...
                            @if(isset($lists))
                               @foreach($lists as $key => $val)
                                   ...
                                   <tr>
                                        ...
                                        <td>{{date('d M Y',strtotime($val->register_date_time))}}</td>
                                        <td>{{$roll_type}}</td>
