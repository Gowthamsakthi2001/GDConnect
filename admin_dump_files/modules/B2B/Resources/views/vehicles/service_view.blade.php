    ...
    <div class="card">
        <div class="card-body">
           <div class="row">
                <div class="col-12">
                    ...
                    <div class="d-flex overflow-auto gap-3 pb-2 mb-2"
                       ...
                       @php
                        // Status configuration (for label and color)
                        $statusConfig = [
                    ...
                    <div class="d-flex flex-row flex-nowrap gap-3 overflow-auto"
                         style="white-space: nowrap; overflow-x: scroll; -ms-overflow-style: none; scrollbar-width: none;">
                        @foreach($data->logs->sortBy('created_at') as $log)
                            @php
                                $status = $log->current_status;
                                $config = $statusConfig[$status] ?? ['label' => ucfirst(str_replace('_', ' ', $status)), 'color' => '#6B7280'];
                            @endphp
           ...
           <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <div class="form-group">
                    <label class="input-label mb-2 ms-1" for="poc_name">POC Name <span style="color:red;">*</span></label>
