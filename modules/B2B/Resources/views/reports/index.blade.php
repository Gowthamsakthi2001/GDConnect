    ...
    <div class="row g-2 g-md-3 mb-3"> <!-- gutter = 8px on small, 16px on md+ -->
        ...
        <div class="col-md-4">
            <div class="d-flex align-items-center p-3" style="border-radius:8px; background-color:#FFFFFF;">
                ...
                <div class="d-flex flex-column justify-content-center">
                    <span style="font-size:16px; font-weight:500;">Service Requests</span>
    ...
    <div class="row g-2 g-md-3"> <!-- gutter = 8px on small, 16px on md+ -->
        <div class="col-md-4">
            <div class="d-flex align-items-center p-3" style="border-radius:8px; background-color:#FFFFFF;">
                ...
                <div class="d-flex flex-column justify-content-center">
                    <span style="font-size:16px; font-weight:500;">Returns</span>
        ...
        <div class="col-md-4">
            <div class="d-flex align-items-center p-3" style="border-radius:8px; background-color:#FFFFFF;">
                ...
                <div class="d-flex flex-column justify-content-center">
                    <span style="font-size:16px; font-weight:500;">Accident</span>
