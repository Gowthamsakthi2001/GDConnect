                ...
                <div class="row">
                      <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="name" id="name" value="{{$request->rider->name ?? ''}}" placeholder="Enter Name" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="mobile_number" id="mobile_number" value="{{$request->rider->mobile_no ?? ''}}" readonly placeholder="Enter Mobile Number">
                            </div>
                        </div>
                </div>
                ...
                <div class="row">
                      <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="email" id="email" value="{{$request->rider->email ?? ''}}" placeholder="Enter Email ID" readonly>
                            </div>
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <label class="input-label mb-2 ms-1" for="start_date">Vehicle Duration Start Date</label>
                                <input type="text" class="form-control bg-white" name="start_date" id="start_date" value="{{$request->start_date ?? ''}}"  readonly>
                            </div>
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <label class="input-label mb-2 ms-1" for="end_date">Vehicle Duration End Date</label>
                                <input type="text" class="form-control bg-white" name="end_date" id="end_date" value="{{$request->end_date ?? ''}}"  readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" disabled>
                                    ...
                                    <option value="1" {{ $request->battery_type == 1 ? 'selected' : '' }}>Removeable</option>
                                    <option value="2" {{ $request->battery_type == 2 ? 'selected' : '' }}>Non Removeable</option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <label class="input-label mb-2 ms-1" for="vehicle_type">Vehicle Type</label>
                                  <select class="form-control" name="vehicle_type" disabled>
                                    ...
                                    <option value="{{$type->id}}" {{ $request->vehicle_type == $type->id ? 'selected' : '' }}>{{$type->name}}</option>
                                    @endforeach
                                    @endif
                                  </select>
                            </div>
                ...
                <div class="row">
                      <div class="col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="adhar_number" id="adhar_number" value="{{$request->rider->adhar_number ?? ''}}" placeholder="Enter Adhar Number" readonly>
                            </div>
                        </div>
                 ...
                 <div class="row">
                      <div class="col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="pan_number" id="pan_number" value="{{$request->rider->pan_number ?? ''}}" placeholder="Enter Pan Number" readonly>
                            </div>
                        </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        @if(pathinfo($request->rider->driving_license_front, PATHINFO_EXTENSION) === 'pdf')
                            <embed src="{{ asset('b2b/driving_license_images/'.$request->rider->driving_license_front) }}"
                                   class="file-preview"
                                   type="application/pdf"
                        ...
                        @endphp
                          @if(!empty($file))
                            @if(pathinfo($request->rider->driving_license_back, PATHINFO_EXTENSION) === 'pdf')
                                <embed src="{{ asset('b2b/driving_license_images/'.$request->rider->driving_license_back) }}"
                                       class="file-preview"
                                       type="application/pdf"
                                       width="100%" height="200px">
                            @else
                 ...
                 <div class="row">
                      <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="license_number" id="license_number" value="{{$request->rider->driving_license_number ?? ''}}" placeholder="Enter License Number" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white"  value="{{$request->rider->dl_expiry_date ?? ''}}" readonly>
                            </div>
                        </div>
                </div>
                        ...
                        @endphp
                          @if(!empty($file))
                            @if(pathinfo($request->rider->llr_image, PATHINFO_EXTENSION) === 'pdf')
                                <embed src="{{ asset('b2b/llr_images/'.$request->rider->llr_image) }}"
                                       class="file-preview"
                                       type="application/pdf"
                                       width="100%" height="200px">
                            @else
                 ...
                 <div class="row">
                      <div class="col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="llr_number" id="llr_number" value="{{ $request->rider->llr_number ?? '' }}" placeholder="Enter LLR Number" readonly>
                            </div>
                        </div>
                </div>
