    ...
    <div class="main-content">
        ...
        <div class="p-3 rounded" style="background:#fbfbfb;">
            <div class="d-flex flex-wrap align-items-center justify-content-between">
                ...
                <!-- Back Button -->
                <a href="{{ route('b2b.returned.list') }}" 
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control bg-white" name="odometer_value" id="odometer_value" value="{{$data->kilometer_value ?? ''}}" readonly>
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                        <label class="form-label">Odometer Image</label>
                        <div class="file-preview-container">
                            @if(!empty($data->kilometer_image))
                                @php
                                    $frontExtension = pathinfo($data->kilometer_image, PATHINFO_EXTENSION);
                                    $frontPath = asset('b2b/kilometer_images/'.$data->kilometer_image);
                                @endphp
