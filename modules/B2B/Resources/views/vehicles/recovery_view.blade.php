                    ...
                    @if(!empty($data->video))
                        ...
                        @elseif(in_array($extension, ['jpg', 'jpeg', 'png', 'gif', 'webp']))
                            ...
                            <img src="{{ $filePath }}" alt="Police Report"
                                 style="width:100%; height:400px; object-fit:contain; border:2px solid #ccc; cursor:pointer;"
                                 onclick="OpenImageModal('{{ $filePath }}')">
                
                        @elseif(in_array($extension, ['mp4', 'mov', 'avi', 'mkv', 'webm']))
                            <!-- Show Video -->
                            <video controls style="width:100%; height:400px; border:2px solid #ccc; border-radius:6px;">
