...
Route::prefix('b2b')
    ...
    ->group(function () {
        ...
        Route::get('/accident-list',[B2BVehicleController::class,'accident_list'])->name('accident.list'); // Logesh Updated
        Route::get('/accident-view/{id}',[B2BVehicleController::class,'accident_view'])->name('accident.view'); // Logesh Updated
        Route::get('/accident-export',[B2BVehicleController::class,'accident_export'])->name('accident_export'); // Logesh Updated
        ...
        Route::get('/service-export',[B2BVehicleController::class,'service_export'])->name('service_export'); // Logesh Updated
