...
public function update_request(Request $request)
{
    ...
    public function assign_vehicle(Request $request)
    {
        ...
        try {
            ...
            $assignVehicle->kilometer_value = $request->kilometer_value ?? 0;
            $assignVehicle->odometer_value  = 0;
...
public function update_return_request(Request $request)
{
    ...
    try {
        ...
        $returnRequest->kilometer_value = $request->kilometer_value ?? 0;
        $returnRequest->odometer_value  = 0;
