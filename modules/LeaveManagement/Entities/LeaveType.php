...
{
    use HasFactory;
    protected $table = 'ev_leave_types';
    protected $fillable = [
        'leave_name',
        'short_name',
        'leave_type',
   ...
   protected $casts = [
    ...
    public function getFormattedUpdatedAtAttribute()
    {
      ...
      public function actionBtn($tableId = 'leave-table')
    {
        return '
            <a href="javascript:void(0);" onclick="AddorEditLeaveFunction('.$this->id.')" class="btn btn-success-soft btn-sm me-1">
            ...
            <button onclick="route_leave_alert(\'' . route('admin.Green-Drive-Ev.leavemanagement.delete', $this->id) . '\', \'Delete this Leave\')" class="btn btn-danger-soft btn-sm">
