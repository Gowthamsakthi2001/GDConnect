...
@endsection
    <div class="main-content">
        ...
        <div class="table-responsive">
                    ...
                    <table id="deployedList" class="table text-left table-striped table-bordered table-hover" style="width: 100%;">
                  ...
                  <div class="modal-content rounded-4">
                    ...
                    <div class="modal-body p-md-3">
                      ...
                      <div class="col-md-3 col-12 mb-3">
                        ...
                        <div class="col-md-3 col-12 mb-3">
                          <div class="d-flex justify-content-between align-items-center">
                            <label class="form-check-label mb-0" for="field4">Rider Name</label>
                            <div class="form-check form-switch m-0">
                        ...
                        <div class="col-md-3 col-12 mb-3">
                          <div class="d-flex justify-content-between align-items-center">
                            <label class="form-check-label mb-0" for="field5">Contact Details</label>
                            <div class="form-check form-switch m-0">
                         ...
                         <div class="col-md-3 col-12 mb-3">
                          <div class="d-flex justify-content-between align-items-center">
                            <label class="form-check-label mb-0" for="field5">Client</label>
                            <div class="form-check form-switch m-0">
                     ...
                     <div class="col-md-3 col-12 mb-3">
                          <div class="d-flex justify-content-between align-items-center">
                            <label class="form-check-label mb-0" for="field6">City</label>
                            <div class="form-check form-switch m-0">
                        ...
                        <div class="col-md-3 col-12 mb-3">
                          <div class="d-flex justify-content-between align-items-center">
                            <label class="form-check-label mb-0" for="field6">Zone</label>
                            <div class="form-check form-switch m-0">
                        ...
                        <div class="col-md-3 col-12 mb-3">
                          <div class="d-flex justify-content-between align-items-center">
                            <label class="form-check-label mb-0" for="field7">Vehicle Duration From Date</label>
                            <div class="form-check form-switch m-0">
                              <input class="form-check-input export-field-checkbox" type="checkbox" id="from_date" name="from_date">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-3 col-12 mb-3">
                          <div class="d-flex justify-content-between align-items-center">
                            <label class="form-check-label mb-0" for="field8">Vehicle Duration End Date</label>
                            <div class="form-check form-switch m-0">
                        ...
                        <div class="col-md-3 col-12 mb-3">
                          <div class="d-flex justify-content-between align-items-center">
                            <label class="form-check-label mb-0" for="field9">Vehicle Type</label>
                            <div class="form-check form-switch m-0">
                        ...
                        <!--<div class="col-md-3 col-12 mb-3">-->
                        <!--  <div class="d-flex justify-content-between align-items-center">-->
                        <!--    <label class="form-check-label mb-0" for="field9">Vehicle Model</label>-->
                        <!--    <div class="form-check form-switch m-0">-->
                        ...
                        <!--<div class="col-md-3 col-12 mb-3">-->
                        <!--  <div class="d-flex justify-content-between align-items-center">-->
                        <!--    <label class="form-check-label mb-0" for="field9">Vehicle Make</label>-->
                        <!--    <div class="form-check form-switch m-0">-->
                        ...
                        <div class="col-md-3 col-12 mb-3">
                          <div class="d-flex justify-content-between align-items-center">
                            <label class="form-check-label mb-0" for="field11">Battery type</label>
                            <div class="form-check form-switch m-0">
                              <input class="form-check-input export-field-checkbox" type="checkbox" id="battery_type" name="battery_type">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-3 col-12 mb-3">
                          <div class="d-flex justify-content-between align-items-center">
                            <label class="form-check-label mb-0" for="field12">Aging</label>
                            <div class="form-check form-switch m-0">
                        ...
                        <div class="col-md-3 col-12 mb-3">
                          <div class="d-flex justify-content-between align-items-center">
                            <label class="form-check-label mb-0" for="field12">Updated Date & Time</label>
                            <div class="form-check form-switch m-0">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRightHR01" aria-labelledby="offcanvasRightHR01Label">
          <div class="offcanvas-header">
            <h5 class="custom-dark" id="offcanvasRightHR01Label">Deployment List</h5>
            ...
            <div class="card mb-3">
               ...
               <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="vehicle_type_id" id="vehicle_type_id" class="form-control custom-select2-field" multiple>
...
function clearRequestFilter() {
    ...
    $('#zone_id').val([]).trigger('change'); // 🔹 reset zones + trigger change
    ...
    $(document).ready(function () {
        // $('#loadingOverlay').show();
         ...
         table = $('#deployedList').DataTable({
            pageLength: 25,
            pagingType: "simple",
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{ route('b2b.admin.deployment_request.list') }}",
                type: 'GET',
                 data: function (d) {
                ...
                d.vehicle_type = $('#vehicle_type_id').val();
                },
            
                beforeSend: function () {
                $('#deployedList tbody').html(`
                  <tr>
            ...
            { data: 9 }, // aging
            { data: 10 },
            { data: 11, orderable: false, searchable: false }, // status
            ...
            //     // Checkbox handling
            //     $('#deployedList').on('change', '.sr_checkbox', function () {
        ...
        // $('#deployedList').on('error.dt', function (e, settings, techNote, message) {
        ...
        // $('#deployedList').on('preDraw.dt', function () {
        //     $('#loadingOverlay').show();
        // });
    
        // $('#deployedList').on('draw.dt', function () {
        //     $('#loadingOverlay').hide();
        // });
    });
  ...
  document.getElementById('export_download').addEventListener('click', function () {
    ...
    // const vehicle_type   = document.getElementById('vehicle_type_id').value;
    const datefilter   = document.getElementById('quick_date_filter').value || '';
    const status = getMultiValues('#status_value');

    const vehicle_type  = getMultiValues('#vehicle_type_id');
    ...
    //     appendMultiSelect(params, 'zone', zone);
    //     appendMultiSelect(params, 'city', city);
    ...
    // const url = `{{ route('b2b.admin.deployment_request.export') }}?${params.toString()}`;
    ...
    $.ajax({
        url: "{{ route('b2b.admin.deployment_request.export') }}",
        method: "GET",
        data: data,
        ...
        success: function(blob) {
            ...
            link.download = "deployment_request_list-" + new Date().toISOString().split('T')[0] + ".csv";
