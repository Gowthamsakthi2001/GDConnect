                    ...
                    <table id="Asset_List" class="table text-left table-striped table-bordered table-hover" style="width: 100%;">
                          <thead class="bg-white rounded" style="background:white !important; color:black !important;">
                            ...
                            <th scope="col" class="custom-dark">Accountablity Type</th>
                              ...
                              <th scope="col" class="custom-dark">Vehicle Make</th>
                ...
                <div class="modal-content rounded-4">
                  ...
                  <div class="modal-body p-md-3">
                    ...
                    <div class="col-md-3 col-12 mb-3">
                      ...
                      <div class="col-md-3 col-12 mb-3">
                        <div class="d-flex justify-content-between align-items-center">
                          <label class="form-check-label mb-0" for="vehicle_model">Vehicle Make</label>
                          <div class="form-check form-switch m-0">
...
<script>
  ...
  $(document).ready(function () {
    ...
    columns: [
            ...
            { data: 14 }, // updated by logesh
            { data: 15 }, // updated by logesh
...
// });
  ...
  document.getElementById('export_download').addEventListener('click', function () {
    ...
    $.ajax({
        url: "{{ route('b2b.admin.deployed_asset.export') }}",
        method: "GET",
        data: data,
        ...
        success: function(blob) {
            ...
            link.download = "deployed_asset_list-" + new Date().toISOString().split('T')[0] + ".csv";
