                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control bg-white" name="battery_type" id="battery_type" value="{{ $data->vehicle?->battery_type ?? ''}}" readonly>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3" hidden>
                        <div class="form-group">
                    ...
                    <div class="col-md-6 mb-3" >
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control bg-white" name="client" id="client" value="{{$data->rider->customerlogin->customer_relation->trade_name ?? ''}}" readonly>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3" >
                        <div class="form-group">
