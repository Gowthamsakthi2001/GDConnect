    ...
    <div class="main-content">
        ...
        <div class="p-3 rounded" style="background:#fbfbfb;">
            <div class="d-flex flex-wrap align-items-center justify-content-between">
                ...
                <!-- Back Button -->
                <a href="{{route('b2b.admin.deployed_asset.deployed_asset_view',encrypt($data->assign_id))}}" 
        ...
        <div class="col-md-12 mb-3">
            ...
            @if(!empty($data->police_report))
                ...
                @elseif(in_array($extension, ['jpg', 'jpeg', 'png', 'gif', 'webp']))
                    <!-- Show Image -->
                    <img src="{{ $filePath }}" alt="Police Report" style="width:100%; height:400px; object-fit:contain; border:1px solid #ccc;" onclick="OpenImageModal('{{ $filePath }}')">
                @else
