...
@endsection
    <div class="main-content">
        ...
        <div class="table-responsive">
                    ...
                    <table id="riderList" class="table text-left table-striped table-bordered table-hover" style="width: 100%;">
                          <thead class="bg-white rounded" style="background:white !important; color:black !important;">
                            <tr>
                              <th scope="col" class="custom-dark text-center">S.No</th>
                              <th scope="col" class="custom-dark text-center">Rider Profile</th>
                              <th scope="col" class="custom-dark text-center">Rider Name</th>
                              <th scope="col" class="custom-dark text-center">Contact No</th>
                              <th scope="col" class="custom-dark text-center">Client</th>
                              <th scope="col" class="custom-dark text-center">City</th>
                              <th scope="col" class="custom-dark text-center">Zone</th>
            ...
            <div class="card mb-3">
               ...
               <div class="card-body">
                    ...
                    <div class="mb-3">
                                ...
                                <label class="form-label mb-0" for="city_id">City</label>
...
$(document).ready(function () {
    ...
    var riderTable = $('#riderList').DataTable({
        pagingType: "simple",
        processing: true,
        serverSide: true,
        ajax: {
            url: "{{ route('b2b.admin.rider.list') }}",
            type: "GET",
            data: function (d) {
        ...
        columns: [
            ...
            { data: 5 },
            { data: 6 },
            { data: 7, className: 'text-center', orderable: false, searchable: false }
        ],
        order: [[0, 'desc']],
        columnDefs: [
...
//             // Checkbox handling
//             $('#riderList').on('change', '.sr_checkbox', function () {
...
//     $('#riderList').on('error.dt', function (e, settings, techNote, message) {
...
//     $('#riderList').on('preDraw.dt', function () {
//         $('#loadingOverlay').show();
//     });

//     $('#riderList').on('draw.dt', function () {
//         $('#loadingOverlay').hide();
//     });
// });
