            ...
            <div class="row">
                ...
                <div class="col-12 mb-4">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <img src="{{ asset('uploads/users/' . $agent->profile_photo_path) }}" 
                             alt="Profile Image" 
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control bg-white" name="name" id="name" value="{{$agent->name ?? ''}}" placeholder="Name" readonly>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control bg-white" name="mobile_no" id="mobile_no" value="{{$agent->phone ?? ''}}" placeholder="Mobile No" readonly>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control bg-white" name="hub" id="hub" value="{{$agent->city->city_name ?? ''}}" placeholder="City" readonly>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control bg-white" name="hub" id="hub" value="{{$agent->zone->name ?? ''}}" placeholder="Zone" readonly>
                    </div>
                </div>
            </div>
        </div>
