                    ...
                    <table id="agentList" class="table text-left table-striped table-bordered table-hover" style="width: 100%;">
                          <thead class="bg-white rounded" style="background:white !important; color:black !important;">
                              <tr>
                                ...
                                <th class="custom-dark">Agent Id</th>
                                <th class="custom-dark">Agent Profile</th>
                                <th class="custom-dark">Agent Name</th>
                                <th class="custom-dark">Agent Contact No</th>
                                <th class="custom-dark">City</th>
                                <th class="custom-dark">Zone</th>
                                <th class="custom-dark">Created At</th>
                                <th class="custom-dark">Updated At</th>
                                <!--<th class="custom-dark">Last Login</th>-->
                                <th class="custom-dark">Deployment Req</th>
                                <th class="custom-dark">Return Req</th>
      ...
      <div class="modal-content rounded-4">
        ...
        <div class="modal-body p-md-3">
          <div class="row p-4">
            ...
            <div class="col-md-3 col-12 mb-3">
              <div class="d-flex justify-content-between align-items-center">
                <label class="form-check-label mb-0" for="age">Age</label>
                <div class="form-check form-switch m-0">
                  <input class="form-check-input export-field-checkbox" type="checkbox" id="age" name="age">
                </div>
              </div>
            </div>
...
<script>
  ...
  $(document).ready(function () {
    ...
    serverSide: true,
    ajax: {
        url: "{{ route('b2b.admin.agent.list') }}",
        type: "GET",
        data: function(d) {
