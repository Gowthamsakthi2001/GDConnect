...
<style>
    ...
    .upload-area:hover {
        border-color:  1px solid #ced4da; /* Change color on hover */
    }
    ...
    <div class="page-header">
         <h2 class="page-header-title">            
               <div class="d-flex justify-content-between">
                    <div>
                        <img src="{{asset('admin-assets/icons/custom/deliveryman.jpg')}}" class="img-fluid rounded"><span class="ps-2"> Add Rider</span>
                    </div>
               </div>
            </h2>
    </div>
            ...
            <form  method="POST" enctype="multipart/form-data" id="wizardForm" class=" g-3 p-3">
                ...
                <div id="wizard">
                    ...
                    <div class="wizard-step">
                             <h5 class="text-primary">{{'Rider Info'}}</h5>
                                ...
                                <div class="row mt-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="input-label mb-2 ms-1" for="interested_city_id">Area <span class="text-danger">*</span></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="upload-area" id="profile_picturs_upload" onclick="document.getElementById('profile_pic').click();">
                                        ...
                                        <div class="upload-content">
                                            ...
                                            <p class="text-center">No file chosen, yet!</p>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="upload-area" id="license_upload_back" onclick="document.getElementById('driving_license_back').click();">
                                                ...
                                                <div class="upload-content">
                                                    <img id="licence_back_preview" class="preview-img" src="" alt="License Preview" />
                                                    <p>No file chosen, yet!</p>
                                                    <button id="imgclose-btn" class="imgclose-btn">&times;</button>
                                                </div>
                                            </div>
                        ...
                        <div class="row gy-4">
                           ...
                           <div class="col-md-12" id="spouse" style="display:none">
                                ...
                                <div class="row">
                                    <div class="col-md-6" >
                                        <div class="form-group">
                                                <label class="input-label mb-2 ms-1" for="spouse_name">{{'Spouse\'s Name'}}</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                              <label class="input-label mb-2 ms-1" for="spouse_mobile_number">{{'Spouse\'s Mobile Number'}}</label>
