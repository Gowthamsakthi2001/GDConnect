                ...
                <div class="card-header" style="background:#fbfbfb;">
                    <div class="row g-3">
                        <div class="col-md-6 d-flex align-items-center">
                            <div class="card-title h5 custom-dark m-0"> <a href="{{route('admin.Green-Drive-Ev.rider_onboard.onboard_log')}}" class="btn btn-sm shadow me-2"><i class="bi bi-arrow-left"></i> </a> View Log Rider Onboarding</div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <form action="#" method="POST">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6 mb-3">
                                <label class="input-label mb-2 ms-1">Role Type </label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="input-label mb-2 ms-1">Onboarded Date </label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="input-label mb-2 ms-1">ID </label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="input-label mb-2 ms-1">Name </label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="input-label mb-2 ms-1">Client ID </label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="input-label mb-2 ms-1">Client Name (Trade Name)</label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="input-label mb-2 ms-1">Created By </label>
                                <input type="text" class="form-control" value="" style="padding:15px;" placeholder="{{$edit_data->createdBy->name ?? ''}} ({{$edit_data->createdBy->get_role->name ?? ''}})" readonly>
                            </div>
                            
                            <div class="col-md-6 mb-3">
                                <label class="input-label mb-2 ms-1">Created At </label>
                                <input type="text" class="form-control" value="" style="padding:15px;" placeholder="{{!empty($edit_data->created_at) ? date('d M Y h:i:s A',strtotime($edit_data ->created_at)) : ''}}" readonly>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label class="input-label mb-2 ms-1">Remarks </label>
                                <textarea class="form-control" readonly>{{$edit_data->remarks ?? ''}}</textarea>
                            </div>
