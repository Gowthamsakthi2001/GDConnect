<x-app-layout>
    ...
    <div class="main-content">
                ...
                <div class="row g-3">
                    <div class="col-md-6 d-flex align-items-center">
                        <div class="card-title h5 custom-dark m-0">
                                Employee
                            <span class="badge text-muted shadow ms-2 p-2" style="background:rgb(234,234,234);">{{ $employees->count()}}</span>
                        </div>
        ...
        <div class="table-responsive">
            <table class="table text-center" style="width: 100%;" id="InsurerNameMasterTable_List">
                <thead class="bg-white rounded" style="background:white !important; color:black !important;">
                    <tr>
                        ...
                        <th scope="col" class="custom-dark">Employee ID</th>
                        <th scope="col" class="custom-dark">Employee Name</th>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end text-center p-1">
                                    <li>
                                        <a href="{{ route('admin.Green-Drive-Ev.employee_categories.employee_view', $employee->id) }}"
