...
<div class="page-header d-flex justify-content-between align-items-center">
    <div class="d-flex align-items-center">
        ...
        <h2 class="page-header-title mb-0">Add Candidate</h2>
    </div>
                    ...
                    <div class="wizard-step">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6 mb-3">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="first_name" id="f_name" 
                                           value="{{old('first_name')}}" placeholder="Ex: John" required>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="last_name" id="l_name" 
                                           value="{{old('last_name')}}" placeholder="Ex: Doe" required>
                         ...
                         <div class="row mt-3">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-floating">
                                    <input type="tel" class="form-control" name="house_no" id="house_no"  value="{{old('house_no')}}" 
                     ...
                     <div class="row mt-3">
                            <div class="col-md-6 mb-3">
                                <div class="form-floating">
                                    <input type="tel" class="form-control" name="street_name" id="street_name"  value="{{old('street_name')}}" 
                                           placeholder=""  required>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-floating">
                                    <input type="tel" class="form-control" name="pincode" placeholder="Enter 6-digit pincode"   oninput="sanitizeAndValidatePincode(this)"  id="pincode" value="{{old('pincode')}}" 
                                           placeholder=""  required>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-floating">
                                    <input type="tel" class="form-control" name="mobile_number" id="mobile_no" 
                                           oninput="sanitizeAndValidatePhone(this)" value="{{old('mobile_number')}}" 
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-floating">
                                         <input type="tel" class="form-control" name="alternative_number" id="alter_number" 
                                           oninput="sanitizeAndValidatePhone(this)" value="{{old('alternative_number')}}" 
                                           placeholder="+917894561230" maxlength="13" required>
                     ...
                     <div class="row mt-3">
                        ...
                        <input type="hidden" name="work_type" id="work_type" value="deliveryman">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="upload-area" id="aadhar_upload_front" onclick="document.getElementById('aadhar_card_front').click();">
                                            ...
                                            <div class="upload-content">
                                                ...
                                                <img id="aadhar_front_preview" class="preview-img" src="" alt="Aadhar Front" />
                                                <iframe class="preview-pdf"></iframe>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="upload-area" id="aadhar_upload_back" 
                                            ...
                                            <div class="upload-content">
                                                ...
                                                <img id="aadhar_back_preview" class="preview-img" src="" alt="Aadhar Back" />
                                             <iframe class="preview-pdf"></iframe>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="aadhar_number" id="aadhar_number" 
                                                   oninput="aadharNumber(this)" value="{{old('aadhar_number')}}" 
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="upload-area" id="pan_upload_front" 
                                            ...
                                            <div class="upload-content">
                                                ...
                                                <p>Upload PAN card</p>
                                                <img id="pan_front_preview" class="preview-img" src="" alt="PAN Card" />
                                            <iframe class="preview-pdf"></iframe>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="pan_number" id="pan_number" 
                                                   oninput="validatePAN()" value="{{old('pan_number')}}" 
                        ...
                        <div id="LicenseSection">
                            ...
                            <div class="col-12 mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="llr_checkbox" 
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            ...
                                            <div class="upload-area" id="license_upload_front" 
                                                ...
                                                <div class="upload-content">
                                                    ...
                                                    <p>Upload front side</p>
                                                    <img id="lisence_front_preview" class="preview-img" src="" alt="License Front" />
                                                     <iframe class="preview-pdf"></iframe>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="upload-area" id="license_upload_back" 
                                                ...
                                                <div class="upload-content">
                                                    <i class="fas fa-id-card-alt"></i>
                                                    <p>Upload back side</p>
                                                    <img id="licence_back_preview" class="preview-img" src="" alt="License Back" />
                                                    <iframe class="preview-pdf"></iframe>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-floating">
                                                ...
                                                <div class="invalid-feedback">Please enter a valid license number (e.g., TN14 1234567)</div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="upload-area" id="llr_upload" 
                                                ...
                                                <div class="upload-content">
                                                    ...
                                                    <img id="llr_preview" class="preview-img" src="" alt="LLR Document" />
                                                    <iframe class="preview-pdf"></iframe>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" name="llr_number" 
                                                       id="llr_number" value="{{ old('llr_number') }}" 
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="bank_name" id="bank_name" 
                                           value="{{old('bank_name')}}" placeholder="Ex: Indian Overseas" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="ifsc_code" id="ifsc_code" 
                                           value="{{old('ifsc_code')}}" placeholder="Ex: IOBA000VEP" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="account_number" id="account_number" 
                                           value="{{old('account_number')}}" placeholder="Ex: 74125896398" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="account_holder_name" id="account_holder_name" 
                                           value="{{old('account_holder_name')}}" placeholder="Ex: John Doe" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="upload-area" id="passbook_upload" 
                                    ...
                                    <div class="upload-content">
                                        ...
                                        <img id="passbook_preview" class="preview-img" src="" alt="Passbook Preview" />
                                        <iframe class="preview-pdf"></iframe>
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="upload-area" id="statement_upload" onclick="document.getElementById('bank_statements').click();">
                                    ...
                                    <div class="upload-content">
                                        <i class="fas fa-passport"></i>
                                        <p>Click to upload</p>
                                        <img id="statement_preview" class="preview-img" src="" alt="Bank Statement Preview" />
                                        <iframe class="preview-pdf"></iframe>
                                    </div>
                             ...
                             <div class="col-md-6 mb-4">
                                ...
                                <div class="upload-area" id="profile_picturs_upload" 
                                    ...
                                    <div class="upload-content">
                                        ...
                                        <img id="profile_preview" class="preview-img" src="" alt="Profile Preview" />
                                        <iframe class="preview-pdf"></iframe>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="present_address" id="present_address" 
                                           value="{{ old('present_address') }}" placeholder="Enter Present Address" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="permanent_address" id="permanent_address" 
                                           value="{{ old('permanent_address') }}" placeholder="Enter Permanent Address" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="tel" class="form-control" name="father_mobile_number" id="father_mobile_number" 
                                           oninput="sanitizeAndValidatePhone(this)" value="{{ old('father_mobile_number') }}" 
                             ...
                             <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="tel" class="form-control" name="referal_person_number" id="referal_person_number" 
                                        oninput="sanitizeAndValidatePhone(this)"   value="{{ old('referal_person_relationship') }}" 
                                           >
                            ...
                            <div class="col-md-6" style="display:none;">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="emergency_contact_person_1_name" 
                                           id="emergency_contact_person_1_name" placeholder="Enter Name">
                            ...
                            <div class="col-md-6" style="display:none;">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="emergency_contact_person_2_name" 
                                           id="emergency_contact_person_2_name" placeholder="Enter Name">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function step_two() {
            ...
            // Skip License & LLR validation if role is in-house
            if (rolevalue === 'in-house') {
                return valid; 
            }
        
            // If role is NOT in-house, follow checkbox logic
            if ($('#llr_checkbox').is(':checked')) {
                valid = validateLLR(valid);
            } else {
                valid = validateLicenseDetails(valid);
            }
        ...
        $('.final-submit').on('click', function (event) {
            ...
            if (step_five()) {
                ...
                $.ajax({
                    url: "{{route('admin.Green-Drive-Ev.hr_status.store_candidate')}}",
                    type: "POST",
                    data: formData,
                    processData: false,  
                    contentType: false,  
                            ...
                            $('.card-body').html(`
                                <div class="text-center py-5 animate__animated animate__fadeIn">
                                    ...
                                    <button class="btn btn-primary" onclick="window.location.reload()">
                                        <i class="fas fa-plus-circle me-2"></i> Add Another Candidate
                                    </button>
                                </div>
                            `);
                        } else {
                            toastr.error(response.message);
                            submitBtn.prop('disabled', false).html('<i class="fas fa-check-circle me-2"></i> Submit Application');
                        }
                    },
                    error: function(xhr) {
...
$(document).on('click', '.imgclose-btn', function() {
    ...
    function validateLicense() {
        ...
        // Define validation regex for license number (varies by country/state)
         const licensePattern = /^[A-Za-z]{2}[0-9]{2}[\s-]?[0-9]{4,8}$/;
