...
class ClientHub extends Model
{
    use HasFactory;
    protected $table = 'ev_client_hubs';
    protected $fillable = [
        'client_id',
        'hub_name',
        'status',
    ];
    public function actionBtn($tableId = 'client-hub-table')
    {
        return '
            <a href="javascript:void(0);" onclick="Edit_hub_modal('.$this->id.')" class="btn btn-success-soft btn-sm me-1">
            ...
            <button onclick="route_alert(\'' . route('admin.Green-Drive-Ev.clients.hub.delete', $this->id) . '\', \'Delete this Client Hub\')" class="btn btn-danger-soft btn-sm">
