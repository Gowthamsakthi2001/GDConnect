...
{
    use HasFactory;
    protected $table = 'ev_tbl_clients';
    ...
    public function actionBtn($tableId = 'client-table')
    {
        return '
            <a href="' . route('admin.Green-Drive-Ev.clients.edit', $this->id) . '" class="btn btn-success-soft btn-sm me-1">
            ...
            <button onclick="route_alert(\'' . route('admin.Green-Drive-Ev.clients.delete', $this->id) . '\', \'Delete this clients\')" class="btn btn-danger-soft btn-sm">
    ...
    {
        return $this->belongsTo(Zones::class, 'client_zone', 'id');
    }
}
