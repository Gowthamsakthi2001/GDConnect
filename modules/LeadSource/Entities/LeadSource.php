...
namespace Modules\LeadSource\Entities;
...
class LeadSource extends Model
{
    ...
    public function actionBtn($tableId = 'lead-source-table')
    {
        return '
            <a href="' . route('admin.Green-Drive-Ev.lead-source.edit', $this->id) . '" class="btn btn-success-soft btn-sm me-1">
            ...
            <button onclick="route_alert(\'' . route('admin.Green-Drive-Ev.lead-source.delete', $this->id) . '\', \'Delete this Lead Source\')" class="btn btn-danger-soft btn-sm">
