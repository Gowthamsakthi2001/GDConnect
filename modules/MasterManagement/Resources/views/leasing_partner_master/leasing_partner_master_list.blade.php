    ...
    <div class="main-content">
                ...
                <div class="card-header" style="background:#fbfbfb;">
                    <div class="row g-3">
                        <div class="col-md-6 d-flex align-items-center">
                            <div class="card-title h5 custom-dark m-0">Leasing Partner Master <span class="badge text-muted shadow ms-2 p-2" style="background:rgb(234,234,234);">{{$data->count()}}</span></div>
                    ...
                    <table id="InsurerNameMasterTable_List" class="table text-left" style="width: 100%;">
                          <thead class="bg-white rounded" style="background:white !important; color:black !important;">
                            <tr>
                              ...
                              <th scope="col" class="custom-dark">Leasing Partner</th>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRightHR01" aria-labelledby="offcanvasRightHR01Label">
          <div class="offcanvas-header">
            <h5 class="custom-dark" id="offcanvasRightHR01Label">Leasing Partner Master</h5>
        ...
        <div class="modal fade" id="AddInsurerNameMaster" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" >Create Leasing Partner Master</h5>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                 ...
                                 <div class="col-12 mb-3">
                                    <label for="vehicle_type" class="mb-2 ms-1">Leasing Partner
                                    <span class="text-danger">*</span></label>
                                        
                                    <input class="form-control basic-single" placeholder="Enter Leasing Partner" name="name" required>
                                </div>
            ...
            <form id="EditInsurerNameMaster_Form" action="javascript:void(0);" method="POST">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" >Update Leasing Partner</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                 ...
                                 <div class="col-12 mb-3">
                                    ...
                                    <input class="form-control basic-single" placeholder="Enter Leasing Partner" name="name" id="name" required>
                                </div>
...
<script>
    $("#AddInsurerNameMaster_From").submit(function (e) {
        ...
        var redirect = "{{ route('admin.Green-Drive-Ev.master_management.leasing_partners.index') }}";
        ...
        $.ajax({
            url: "{{ route('admin.Green-Drive-Ev.master_management.leasing_partners.store') }}",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
      ...
      $(document).on('click', '.editInsurerBtn', function () {
        ...
        $.ajax({
            url: "{{ route('admin.Green-Drive-Ev.master_management.leasing_partners.get_data', ':id') }}".replace(':id', id),
            type: "POST",
            data: {
                _token: "{{ csrf_token() }}"
            },
        ...
        $.ajax({
            url: "{{ route('admin.Green-Drive-Ev.master_management.leasing_partners.update') }}", // Update route
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
    ...
    $('.toggle-status').change(function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                // Proceed with AJAX
                $.ajax({
                    url: "{{ route('admin.Green-Drive-Ev.master_management.leasing_partners.status_update') }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
                        id: Id,
...
<script>
  document.getElementById('exportBtn').addEventListener('click', function () {
    ...
    const url = `{{ route('admin.Green-Drive-Ev.master_management.leasing_partners.export') }}?${params.toString()}`;
