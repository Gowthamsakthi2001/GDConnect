...
$(document).ready(function () {
    ...
    $(document).on('click', '.edit-btn', function() {
        let id = $(this).data('id');
        $.get(`/admin/sidebar-modules/${id}/edit`, function(data) {
            $('#editForm input[name="module_name"]').val(data.module_name);
            $('#editForm input[name="route_name"]').val(data.route_name);
    ...
    $('#bulkDeleteBtn').click(function() {
        ...
        $.ajax({
            url: '/admin/sidebar-modules/bulk-delete',
            method: 'POST',
