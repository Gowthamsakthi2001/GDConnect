...
<style>
    ...
    <div class="main-content">
                ...
                <div class="card-header" style="background:#fbfbfb;">
                    <div class="row g-3">
                        <div class="col-md-6 d-flex align-items-center">
                            <div class="card-title h5 custom-dark m-0">Telemetric OEM Master <span class="badge text-muted shadow ms-2 p-2" style="background:rgb(234,234,234);">{{$data->count()}}</span></div>
                        ...
                        <div class="col-md-6 d-flex gap-2 align-items-center justify-content-end">
                            ...
                            <div class="text-center d-flex gap-2">
                                ...
                                <div class="m-2 btn btn-success d-flex align-items-center px-3"
                                    style="cursor: pointer;"      data-bs-toggle="modal" data-bs-target="#AddTelematricMaster">
        ...
        <div class="table-responsive">
                    <table id="TelemetricMasterTable_List" class="table text-left" style="width: 100%;">
                          <thead class="bg-white rounded" style="background:white !important; color:black !important;">
                            <tr>
                              ...
                              <th scope="col" class="custom-dark">Telemetric OEM Name</th>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRightHR01" aria-labelledby="offcanvasRightHR01Label">
          <div class="offcanvas-header">
            <h5 class="custom-dark" id="offcanvasRightHR01Label">Telemetric OEM Master</h5>
            <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
          </div>
          <div class="offcanvas-body">
        
            <div class="d-flex gap-2 mb-3">
                <button class="btn btn-outline-secondary w-50" onclick="clearTelemetricFilter()">Clear All</button>
                <button class="btn btn-success w-50" onclick="applyTelemetricFilter()">Apply</button>
            </div>
        ...
        <div class="modal fade" id="AddTelematricMaster" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            aria-labelledby="AddTelematricMaster" aria-hidden="true">
            <form id="AddTelematricMaster_From" action="javascript:void(0);" method="POST">
                @csrf
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" >Create Telemetric OEM</h5>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                 ...
                                 <div class="col-12 mb-3">
                                    <label for="vehicle_type" class="mb-2 ms-1">Telemetric OEM
                                    <span class="text-danger">*</span></label>
                                        
                                    <input class="form-control basic-single" placeholder="Enter Telemetric OEM" name="telemetric_name" required>
                                </div>
            ...
            <form id="EditTelematricMaster_From" action="javascript:void(0);" method="POST">
                @csrf
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" >Update Telemetric OEM</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                 ...
                                 <div class="col-12 mb-3">
                                    ...
                                    <input class="form-control basic-single" placeholder="Enter Telemetric OEM" name="telemetric_name" id="telemetric_name" required>
                                </div>
...
<script>
        ...
        function applyTelemetricFilter() {
    ...
    function clearTelemetricFilter() {
        const url = new URL(window.location.href);
...
<script>
        ...
        $(document).ready(function () {
       $('#TelemetricMasterTable_List').DataTable({
            // dom: 'Blfrtip',
            // dom: 'frtip',
...
<script>
    $("#AddTelematricMaster_From").submit(function (e) {
        e.preventDefault();
        ...
        var redirect = "{{ route('admin.Green-Drive-Ev.master_management.telematric_oem_master.list') }}";
        ...
        $.ajax({
            url: "{{ route('admin.Green-Drive-Ev.master_management.telematric_oem_master.store') }}",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
            success: function (response) {
                if (response.success) {
                    ...
                    $("#AddTelematricMaster").modal('hide');
                    form.reset();
                    setTimeout(function () {
      ...
      $(document).on('click', '.editTelemetricOEMBtn', function () {
        ...
        $.ajax({
            url: "{{ route('admin.Green-Drive-Ev.master_management.telematric_oem_master.get_data', ':id') }}".replace(':id', id),
            type: "POST",
            data: {
                _token: "{{ csrf_token() }}"
            },
            success: function (response) {
                if (response.success) {
                    ...
                    $('#telemetric_name').val(response.data.name);
        ...
        $("#EditTelematricMaster_From").submit(function (e) {
        e.preventDefault();
        ...
        $.ajax({
            url: "{{ route('admin.Green-Drive-Ev.master_management.telematric_oem_master.update') }}", // Update route
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
    ...
    $('.toggle-status').change(function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                // Proceed with AJAX
                $.ajax({
                    url: "{{ route('admin.Green-Drive-Ev.master_management.telematric_oem_master.status_update') }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
                        id: Id,
...
<script>
  document.getElementById('exportBtn').addEventListener('click', function () {
    ...
    const url = `{{ route('admin.Green-Drive-Ev.master_management.telematric_oem_master.export_telemetric_master') }}?${params.toString()}`;
