  ...
  overflow-x: hidden !important;
    ...
    <div class="main-content">
                ...
                <div class="card-header" style="background:#fbfbfb;">
                    <div class="row g-3">
                        <div class="col-md-6 d-flex align-items-center">
                            <div class="card-title h5 custom-dark m-0">Hypothecations<span class="badge text-muted shadow ms-2 p-2" style="background:rgb(234,234,234);">{{count($lists)}}</span></div>
                        ...
                        <div class="col-md-6 d-flex gap-2 align-items-center justify-content-end">
                            ...
                            <div class="text-center d-flex gap-2">
                                ...
                                <!--<div class="m-2 bg-white p-2 px-3 border-gray" onclick="window.location.href='{{route('admin.asset_management.quality_check_list.export',['status'=>$status,'from_date'=>$from_date,'to_date'=>$to_date])}}'"><i class="bi bi-download fs-17 me-1"></i> Export</div>-->
                                <div class="m-2 bg-white p-2 px-3 border-gray" onclick="HYP_Excel_Export()"><i class="bi bi-download fs-17 me-1"></i> Export</div>
                                ...
                                <div class="m-2 btn btn-success d-flex align-items-center px-3"
                                    onclick="AddorEditHypothecationModal('0',this)"
        ...
        <div class="table-responsive">
                    <table id="HypocationTableList" class="table text-center" style="width: 100%;">
                        <thead class="bg-white rounded" style="background:white !important; color:black !important;">
                            <tr>
                                ...
                                <th scope="col" class="custom-dark text-center">Hypothecation Name</th>
                                ...
                                <tr>
                                   ...
                                   <td>
                                       <a href="javascript:void(0);" 
                                           ...
                                           onclick="AddorEditHypothecationModal('{{ $val->id }}', this)" 
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRightHypothecation01" aria-labelledby="offcanvasRightHypothecation01Label">
          <div class="offcanvas-header">
            <h5 class="custom-dark" id="offcanvasRightHypothecation01Label">Hypocations Filter</h5>
            <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
          </div>
          <div class="offcanvas-body">
        
            <div class="d-flex gap-2 mb-3">
                <button class="btn btn-outline-secondary w-50" onclick="clearHypothecationFilter()">Clear All</button>
                <button class="btn btn-success w-50" onclick="applyHypothecationFilter()">Apply</button>
            </div>
     ...
     <div class="modal fade" id="AddorEditHypothecation" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="AddorEditHypothecationLabel" aria-hidden="true">
        <form id="AddorEdit_HYP_Form" action="javascript:void(0);" method="POST">
            @csrf
            <input type="hidden" name="edit_id" id="Edit_HYP_ID" value="">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="AddorEditHypothecationLabel">Enter a Details</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                             ...
                             <div class="col-12 mb-3">
                                ...
                                <input type="text" name="hypothecation_name" id="hypothecation_name" class="form-control" placeholder="Enter a Name">
...
<script>
    ...
    function applyHypothecationFilter() {
    ...
    function clearHypothecationFilter() {
        const url = new URL(window.location.href);
  ...
  function AddorEditHypothecationModal(id, el) {
        if (id == 0) {
            $("#AddorEditHypothecationLabel").text("Enter a Details");
            $("#AddorEditHypothecation").modal('show');
            $('#AddorEditHypothecation form').trigger('reset');
        } else {
            $("#AddorEditHypothecationLabel").text("Update a Details");
            ...
            $("#AddorEditHypothecation").modal('show');
            $("#Edit_HYP_ID").val(id);
            $('#hypothecation_name').val(hyp_name);
            $("#edit_status").val(status);
        }
    }

  
  $("#AddorEdit_HYP_Form").submit(function(){
        var form = $(this)[0];
            ...
            success: function(response) {
                ...
                if (response.success == true) {
                   toastr.success(response.message);
                    $("#AddorEditHypothecation").modal('hide');
                    form.reset();
                   setTimeout(function(){
