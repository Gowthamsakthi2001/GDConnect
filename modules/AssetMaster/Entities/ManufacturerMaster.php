...
use Modules\AssetMaster\Database\factories\ManufacturerMasterFactory;

class ManufacturerMaster extends Model
{
    use HasFactory;

    protected $table = 'ev_manufacturer_master';
    ...
    public function actionBtn($tableId = 'manufacture-master-table')
    {
        return '
            <a href="' . route('admin.Green-Drive-Ev.asset-master.manufacturer_master_edit', $this->id) . '" class="btn btn-success-soft btn-sm me-1">
            ...
            <button onclick="route_alert(\'' . route('admin.Green-Drive-Ev.asset-master.manufacturer_master_delete', $this->id) . '\', \'Delete this ManufacturerMaster\')" class="btn btn-danger-soft btn-sm">
