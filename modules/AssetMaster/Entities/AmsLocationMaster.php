...
use Modules\AssetMaster\Database\factories\AmsLocationMasterFactory;

class AmsLocationMaster extends Model
{
    use HasFactory;
    
    protected $table = 'ev_ams_location_master';
    ...
    public function actionBtn($tableId = 'ams-location-master')
    {
        return '
            <a href="' . route('admin.Green-Drive-Ev.asset-master.ams_location_master_edit', $this->id) . '" class="btn btn-success-soft btn-sm me-1">
            ...
            <button onclick="route_alert(\'' . route('admin.Green-Drive-Ev.asset-master.ams_location_master_delete', $this->id) . '\', \'Delete this AMS Location Master\')" class="btn btn-danger-soft btn-sm">
