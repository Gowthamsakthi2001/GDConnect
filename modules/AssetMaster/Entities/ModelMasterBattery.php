...
use Modules\AssetMaster\Database\factories\ModelMasterBatteryFactory;

class ModelMasterBattery extends Model
{
    use HasFactory;

     protected $table = 'ev_modal_master_battery';
    ...
    protected $fillable = [
        ...
        'dod_percentage',
        'connector_rating',
        'warranty_expiry_cycles',
        'warranty_expiry_duration',
        'warranty_expiry_param_priority',
        'status'
    ];

    protected $casts = [
        'current_rating_Ah' => 'float',
        ...
        'smart_bms_available' => 'boolean',
        'smart_bms_features' => 'array',
        'dod_percentage' => 'integer',
        'connector_rating' => 'integer',
        'warranty_expiry_cycles' => 'integer',
        'warranty_expiry_duration' => 'integer',
    ];
    
    public function actionBtn($tableId = 'modal-master-battery-table')
    {
        return '
            <a href="' . route('admin.Green-Drive-Ev.asset-master.modal_master_battery_edit', $this->id) . '" class="btn btn-success-soft btn-sm me-1">
            ...
            <button onclick="route_alert(\'' . route('admin.Green-Drive-Ev.asset-master.modal_master_battery_delete', $this->id) . '\', \'Delete this Master Modal Battery\')" class="btn btn-danger-soft btn-sm">
