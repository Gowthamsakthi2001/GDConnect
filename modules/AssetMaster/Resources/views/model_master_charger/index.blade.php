<x-app-layout>
    <div class="container mt-5">
        ...
        <form action="{{route('admin.Green-Drive-Ev.asset-master.model_master_charger_store')}}" method="POST">
            @csrf <!-- Laravel CSRF Token -->
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="name" class="form-label">Charger Name</label>
                    <input type="text" class="form-control" id="name" name="name" 
                           value="{{ old('name') }}" placeholder="Enter Charger Name" required>
                </div>
                <div class="col-md-6">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" step="0.1" class="form-control" id="nominal_c_rating" name="nominal_c_rating" 
                           value="{{ old('nominal_c_rating') }}" placeholder="Enter Nominal C Rating" required>
                </div>
                <div class="col-md-6">
                    ...
                    <select class="form-control" id="charging_mode" name="charging_mode" required>
                        <option value="fast" {{ old('charging_mode') == 'fast' ? 'selected' : '' }}>Fast</option>
                        <option value="slow" {{ old('charging_mode') == 'slow' ? 'selected' : '' }}>Slow</option>
                    </select>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" step="0.1" class="form-control" id="output_voltage" name="output_voltage" 
                           value="{{ old('output_voltage') }}" placeholder="Enter Output Voltage" required>
                </div>
                <div class="col-md-6">
                    ...
                    <input type="number" step="0.1" class="form-control" id="output_current" name="output_current" 
                           value="{{ old('output_current') }}" placeholder="Enter Output Current" required>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" step="0.1" class="form-control" id="input_voltage" name="input_voltage" 
                           value="{{ old('input_voltage') }}" placeholder="Enter Input Voltage" required>
                </div>
                <div class="col-md-6">
                    ...
                    <input type="number" step="0.1" class="form-control" id="input_current" name="input_current" 
                           value="{{ old('input_current') }}" placeholder="Enter Input Current" required>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="connector_rating" name="connector_rating" 
                           value="{{ old('connector_rating') }}" placeholder="Enter Connector Rating" required>
                </div>
                <div class="col-md-6">
