<x-app-layout>     
    <div class="container mt-5">
        ...
        <form action="{{route('admin.Green-Drive-Ev.asset-master.asset_master_charger_store')}}" method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" id="PO_ID" name="PO_ID" 
                           value="{{ old('PO_ID') }}" placeholder="Enter PO ID" required>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="Charger_Model" name="Charger_Model" 
                           value="{{ old('Charger_Model') }}" placeholder="Enter Charger Model">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="Engraved_Serial_Num" name="Engraved_Serial_Num" 
                           value="{{ old('Engraved_Serial_Num') }}" placeholder="Enter Engraved Serial Number">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control" id="In_Use_Date" name="In_Use_Date" 
                           value="{{ old('In_Use_Date',\Carbon\Carbon::now()->format('Y-m-d')) }}" required>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="Assigned_to" name="Assigned_to" 
                           value="{{ old('Assigned_to') }}" placeholder="Enter Assigned To">
                </div>
                <div class="col-md-6">
