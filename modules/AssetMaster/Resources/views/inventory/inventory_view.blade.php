...
.nav-pills .nav-link.active {
                ...
                <div class="card-header" style="background:#fbfbfb;">
                    <div class="row g-3">
                        <div class="col-md-6 d-flex align-items-center">
                              <div class="card-title h5 custom-dark m-0"> <a href="{{route('admin.asset_management.asset_master.inventory.list')}}" class="btn btn-sm shadow me-2"><i class="bi bi-arrow-left"></i> </a>View Asset Details
                              </div>
                        </div>
     ...
     <div class="card my-3">
           ...
           <div class="card-header" style="background:#f1f5f9;">
                <ul class="nav nav-pills row d-flex align-items-center" id="pills-tab" role="tablist">
                  ...
                  <li class="nav-item col-md-6 d-flex align-items-center justify-content-center" role="presentation">
                    <button class="nav-link active" id="pills-assets-section-tab" data-bs-toggle="pill" data-bs-target="#pills-assets-section" type="button" role="tab" aria-controls="pills-assets-section" aria-selected="false"><img src="{{asset('public/admin-assets/icons/custom/kyc_doc.png')}}" alt="image">&nbsp; <span class="head-text" style="color:#adb3bb;">Asset Details</span></button>
                  </li>
                  <li class="nav-item col-md-6 d-flex align-items-center justify-content-center" role="presentation">
                    <button class="nav-link" id="pills-log-section-comments-tab" data-bs-toggle="pill" data-bs-target="#pills-log-section-comments" type="button" role="tab" aria-controls="pills-log-section-comments" aria-selected="false"><img src="{{asset('public/admin-assets/icons/custom/query.png')}}" alt="image">&nbsp; <span class="head-text" style="color:#adb3bb;">Logs & History</span></button>
                  </li>
    ...
    <div class="card-body" style="background:#fbfbfb;">
        ...
        <div class="tab-pane fade show active" id="pills-assets-section" role="tabpanel" aria-labelledby="pills-assets-section-tab" tabindex="0">
            <div class="card">
                       <div class="card-header" style="background:#eef2ff;">
                                  <h5 style="color:#5e1b1b;" class="fw-bold">Assets Details</h5>
                                    <p class="mb-0" style="color:#5e1b1b;">Asset in details</p>
                       </div>
                <div class="card-body">
                                ...
                                <select class="form-select custom-select2-field form-control-sm bg-white"  disabled>
                                    ...
                                    @if(isset($passed_chassis_numbers))
                                       @foreach($passed_chassis_numbers as $val)
                                          <option value="{{$val->id}}" {{$data->assetVehicle->id == $val->id ? 'selected' : ''}}>{{$val->chassis_number}}</option>
                                       @endforeach
                                    @endif
                                </select>
                            </div>
                        </div>
                        <input id="chassis_number" name="chassis_number" value="{{$data->assetVehicle->chassis_number ?? ''}}" type="hidden">
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <label class="input-label mb-2 ms-1" for="vehicle_category">Vehicle Category</label>
                                <!--<input type="text" class="form-control bg-white" style="padding:12px 20px;" name="vehicle_category" id="vehicle_category"  value="{{$data->assetVehicle->vehicle_category ?? ''}}" placeholder="Enter Vehicle Category" >-->
                                <select class="form-control bg-white" name="vehicle_category" style="padding:12px 20px;" id="vehicle_category">
                                    <option value="">Select</option>
                                    <option value="regular_vehicle" {{ ($data->assetVehicle->vehicle_category ?? '') == 'regular_vehicle' ? 'selected' : '' }} >Regular Vehicle</option>
                                    <option value="low_speed_vehicle" {{ ($data->assetVehicle->vehicle_category ?? '') == 'low_speed_vehicle' ? 'selected' : '' }} >Low Speed Vehicle</option>
                                 </select>
                                ...
                                <select class="form-select custom-select2-field form-control-sm"  disabled>
                                    ...
                                    @if(isset($vehicle_types))
                                       @foreach($vehicle_types as $type)
                                          <option value="{{$type->id}}" {{$data->assetVehicle->vehicle_type == $type->id ? 'selected' : ''}}>{{$type->name}}</option>
                                       @endforeach
                                    @endif
                                </select>
                            </div>
                        </div>
                        <input type="hidden" id="vehicle_type" name="vehicle_type" value="{{$data->assetVehicle->vehicle_type}}">
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <label class="input-label mb-2 ms-1" for="model">Model</label>
                                <!--<input type="text" class="form-control bg-white" name="model" id="model"  value="{{$data->assetVehicle->model ?? ''}}" placeholder="Enter Model" >-->
                                
                                   <select class="form-select custom-select2-field form-control-sm"  disabled>
                                        <option value="">Select</option>
                                        @if(isset($vehicle_models))
                                           @foreach($vehicle_models as $type)
                                              <option value="{{$type->id}}"  data-id="{{$type->id}}" data-make="{{$type->make}}" data-variant="{{$type->variant}}" data-color="{{$type->color}}" {{$data->assetVehicle->model == $type->id ? 'selected' : ''}}>{{$type->vehicle_model}}</option>
                                           @endforeach
                                        @endif
                                    </select>
                            </div>
                        </div>
                         <input type="hidden" id="model" name="model" value="{{$data->assetVehicle->model}}">
                         
                    @php
                        $model_data = \Modules\AssetMaster\Entities\VehicleModelMaster::where('id', $data->assetVehicle->model)->first();
                    @endphp
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <!--<input type="text" class="form-control bg-white" style="padding: 12px 20px;" name="make" id="make"  value="{{$data->assetVehicle->make ?? ''}}" placeholder="Enter Make" >-->
                                <select class="form-select custom-select2-field form-control-sm"  disabled>
                                       @if($model_data)
                         ...
                         <input type="hidden" name="make" id="make" value="{{$data->assetVehicle->make}}">


                         <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <label class="input-label mb-2 ms-1" for="variant">Variant</label>
                                <!--<input type="text" class="form-control bg-white" name="variant" id="variant"  value="{{$data->assetVehicle->variant ?? ''}}" placeholder="Enter Variant" >-->
                             <select class="form-select custom-select2-field form-control-sm"  disabled>
                                       @if($model_data)
                        ...
                        <input type="hidden" name="variant" id="variant" value="{{$data->assetVehicle->variant}}">
                        
                         <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <label class="input-label mb-2 ms-1" for="color">Color</label>
                                <!--<input type="text" class="form-control bg-white" name="color" id="color"  value="{{$data->assetVehicle->color ?? ''}}" placeholder="Enter Color" >-->
                                 <select class="form-select custom-select2-field form-control-sm" name="color" id="color" >
                                    <option value="">Select</option>
                                     @if(isset($colors))
                                           @foreach($colors as $color)
                                              <option value="{{$color->id}}"  {{$data->assetVehicle->color == $color->id ? 'selected' : ''}}>{{$color->name}}</option>
                                           @endforeach
                                        @endif
                                </select>
                            </div>
                         ...
                         <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="motor_number" id="motor_number"  value="{{$data->assetVehicle->motor_number ?? ''}}" placeholder="Enter Engine Number/Motor Number" readonly>
                            </div>
                        </div>
                         <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <label class="input-label mb-2 ms-1" for="vehicle_id">Vehicle ID</label>
                                <input type="text" class="form-control bg-white" name="vehicle_id" id="vehicle_id"  value="{{$data->assetVehicle->vehicle_id ?? ''}}" placeholder="Enter Vehicle ID" >
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <label class="input-label mb-2 ms-1" for="tax_invoice_number">Tax Invoice Number</label>
                                <input type="text" class="form-control bg-white" name="tax_invoice_number" id="tax_invoice_number"  value="{{$data->assetVehicle->tax_invoice_number ?? ''}}" placeholder="Enter Tax Invoice Number" >
                            </div>
                        </div>
                         ...
                         <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control bg-white" name="tax_invoice_date" id="tax_invoice_date"  value="{{ $data->assetVehicle->tax_invoice_date ? date('Y-m-d', strtotime($data->assetVehicle->tax_invoice_date)) : '' }}" placeholder="Enter Tax Invoice Date" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="tax_invoice_value" id="tax_invoice_value"  value="{{$data->assetVehicle->tax_invoice_value ?? ''}}" onkeypress="return isNumberKeyNew(event)" placeholder="Enter Invoice Value/Purchase Price" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                         ...
                         <?php
                                ...
                                $TaxInvoiceattachment = $data->assetVehicle->tax_invoice_attachment ?? '';
                        ...
                        <div class="col-md-12 mb-4 my-4">
                            <div class="preview-container border rounded shadow overflow-hidden position-relative"
                                ...
                                <button type="button"
                                        ...
                                        onclick="resetPreview('tax_invoice_Image')">
                                    ✖
                                </button>
                                ...
                                <img id="tax_invoice_Image"
                                     ...
                                     style="max-height: 300px; object-fit: cover; {{ $isTaxInvoicePDF ? 'display:none;' : '' }}">
                                ...
                                <select class="form-select custom-select2-field form-control-sm bg-white" id="location" name="location">
                                    ...
                                    @if(isset($locations))
                                       @foreach($locations as $val)
                                          <option value="{{$val->id}}" {{$data->assetVehicle->location == $val->id ? 'selected' : ''}}>{{$val->name}}</option>
                                       @endforeach
                                    @endif
                                </select>
                            </div>
                       ...
                       <div class="col-md-6 mb-3">
                         ...
                         <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" style="padding:12px 20px;" name="gd_hub_id" id="gd_hub_id"  value="{{$data->assetVehicle->gd_hub_name ?? ''}}" placeholder="Enter GD Hub ID Allocated" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" style="padding:12px 20px;" name="gd_hub_id_exiting" id="gd_hub_id_exiting"  value="{{$data->assetVehicle->gd_hub_id ?? ''}}"  placeholder="Enter GD Hub ID Existing">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <!--<input type="text" class="form-control bg-white" name="financing_type" id="financing_type"  value="{{$data->assetVehicle->financing_type ?? ''}}" placeholder="Financing Type" >-->
                             <select class="form-select custom-select2-field form-control-sm" name="financing_type" id="financing_type">
                                    ...
                                    @if(isset($financing_types))
                                       @foreach($financing_types as $val)
                                          <option value="{{$val->id}}" {{$data->assetVehicle->financing_type == $val->id ? 'selected' : ''}}>{{$val->name}}</option>
                                       @endforeach
                                    @endif
                                </select>
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <!--<input type="text" class="form-control bg-white" name="asset_ownership" id="asset_ownership"  value="{{$data->assetVehicle->asset_ownership ?? ''}}" placeholder="Enter Asset Ownership" >-->
                                ...
                                <select class="form-select custom-select2-field form-control-sm" name="asset_ownership" id="asset_ownership">
                                    ...
                                    @if(isset($asset_ownerships))
                                       @foreach($asset_ownerships as $val)
                                          <option value="{{$val->id}}" {{$data->assetVehicle->asset_ownership == $val->id ? 'selected' : ''}}>{{$val->name}}</option>
                                       @endforeach
                                    @endif
                                </select>
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <select class="form-select custom-select2-field form-control-sm" name="leasing_partner" id="leasing_partner">
                                    <option value="">Select</option>
                                    @if(isset($leasing_partner))
                                       @foreach($leasing_partner as $val)
                                          <option value="{{$val->id}}" {{$data->assetVehicle->leasing_partner == $val->id ? 'selected' : ''}}>{{$val->name}}</option>
                                       @endforeach
                                    @endif
                                </select>
                            </div>
                        ...
                        <?php
                        // $image_src = !empty($data->assetVehicle->master_lease_agreement)
                        //     ? asset("EV/asset_master/master_lease_agreements/{$data->assetVehicle->master_lease_agreement}")
                        //     : asset("admin-assets/img/defualt_upload_img.jpg");
                            
                              $MasterLeaseattachment = $data->assetVehicle->master_lease_agreement ?? '';
                                $defaultImage = asset('admin-assets/img/defualt_upload_img.jpg');
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control bg-white" name="lease_start_date" id="lease_start_date"  value="{{ $data->assetVehicle->lease_start_date ? date('Y-m-d', strtotime($data->assetVehicle->lease_start_date)) : '' }}" placeholder="Enter Lease Start Date" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control bg-white" name="lease_end_date" id="lease_end_date"  value="{{ $data->assetVehicle->lease_end_date ? date('Y-m-d', strtotime($data->assetVehicle->lease_end_date)) : '' }}" placeholder="Enter Lease End Date" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="emi_lease_amount" id="emi_lease_amount"  value="{{$data->assetVehicle->emi_lease_amount ?? ''}}" onkeypress="return isNumberKeyNew(event)" placeholder="Enter EMI/Lease Amount" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <!--<input type="text" class="form-control bg-white" name="hypothecation" id="hypothecation"  value="{{$data->assetVehicle->hypothecation ?? ''}}" placeholder="Enter Hypothecation" >-->
                             <select class="form-control bg-white" name="hypothecation" style="padding:12px 20px;" id="hypothecation">
                                    <option>Select</option>
                                  <option value="yes" {{ (isset($data->assetVehicle->hypothecation) && $data->assetVehicle->hypothecation == 'yes') ? 'selected' : '' }}>Yes</option>
                                <option value="no" {{ (isset($data->assetVehicle->hypothecation) && $data->assetVehicle->hypothecation == 'no') ? 'selected' : '' }}>No</option>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <!--<input type="text" class="form-control bg-white" name="hypothecation_to" id="hypothecation_to"  value="{{$data->assetVehicle->hypothecation_to ?? ''}}" placeholder="Enter Hypothecation To" >-->
                                    ...
                                    @if(isset($hypothecations))
                                       @foreach($hypothecations as $val)
                                          <option value="{{$val->id}}" {{$data->assetVehicle->hypothecation_to == $val->id ? 'selected' : ''}}>{{$val->name}}</option>
                                       @endforeach
                                    @endif
                                </select>
                            </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control bg-white" name="hypothecation_document" id="hypothecation_document" accept="image/png,image/jpeg,image/jpg,application/pdf" onchange="showImagePreview(this,'hypothecation_documentImage')">
                            </div>
                        </div>
                        
                                                <?php
                        // $image_hypo = !empty($data->assetVehicle->hypothecation_document)
                        //     ? asset("EV/asset_master/hypothecation_documents/{$data->assetVehicle->hypothecation_document}")
                        //     : asset("admin-assets/img/defualt_upload_img.jpg");
                        
                                $Hypothecationattachment = $data->assetVehicle->hypothecation_document ?? '';
                                $defaultImage = asset('admin-assets/img/defualt_upload_img.jpg');
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <!--<input type="text" class="form-control bg-white" name="insurance_type" id="insurance_type"  value="{{$data->assetVehicle->insurance_type ?? ''}}" placeholder="Enter Insurance Type" >-->
                            <select class="form-select custom-select2-field form-control-sm" name="insurance_type" id="insurance_type">
                                    ...
                                    @if(isset($insurance_types))
                                       @foreach($insurance_types as $val)
                                          <option value="{{$val->id}}" {{$data->assetVehicle->insurance_type == $val->id ? 'selected' : ''}}>{{$val->name}}</option>
                                       @endforeach
                                    @endif
                                </select>
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <!--<input type="text" class="form-control bg-white" name="insurer_name" id="insurer_name"  value="{{$data->assetVehicle->insurer_name ?? ''}}" placeholder="Enter Insurer Name" >-->
                                 <select class="form-select custom-select2-field form-control-sm" name="insurer_name" id="insurer_name">
                                    ...
                                    @if(isset($insurer_names))
                                       @foreach($insurer_names as $val)
                                          <option value="{{$val->id}}" {{$data->assetVehicle->insurer_name == $val->id ? 'selected' : ''}}>{{$val->name}}</option>
                                       @endforeach
                                    @endif
                                </select>
                            </div>
                         ...
                         <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="insurance_number" id="insurance_number"  value="{{$data->assetVehicle->insurance_number ?? ''}}" placeholder="Enter Insurance Number" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control bg-white" name="insurance_start_date" id="insurance_start_date"  value="{{ $data->assetVehicle->insurance_start_date ? date('Y-m-d', strtotime($data->assetVehicle->insurance_start_date)) : '' }}" placeholder="Enter Insurance Start Date" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control bg-white" name="insurance_expiry_date" id="insurance_expiry_date"  value="{{ $data->assetVehicle->insurance_expiry_date ? date('Y-m-d', strtotime($data->assetVehicle->insurance_expiry_date)) : '' }}" placeholder="Enter Insurance Expiry Date" >
                            </div>
                        </div>
                         ...
                         <div class="col-md-6 mb-3">
                           ...
                           <?php
                            // $image_src1 = !empty($data->assetVehicle->insurance_attachment)
                            //     ? asset("EV/asset_master/insurance_attachments/{$data->assetVehicle->insurance_attachment}")
                            //     : asset("admin-assets/img/defualt_upload_img.jpg");
                            
                                $insuranceAttachment = $data->assetVehicle->insurance_attachment ?? '';
                                $defaultImage = asset('admin-assets/img/defualt_upload_img.jpg');
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <!--<input type="text" class="form-control bg-white" name="registration_type" id="registration_type"  value="{{$data->assetVehicle->registration_type ?? ''}}" placeholder="Enter Registration Type" >-->
                                 <select class="form-select custom-select2-field form-control-sm" name="registration_type" id="registration_type">
                                    ...
                                    @if(isset($registration_types))
                                       @foreach($registration_types as $val)
                                          ...
                                          <option value="{{$val->id}}" {{$data->assetVehicle->registration_type == $val->id ? 'selected' : ''}}>{{$val->name}}</option>
                                       @endforeach
                                    @endif
                                </select>
                            </div>
                        ...
                        <div class="col-md-6 mb-3" hidden>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="registration_status" id="registration_status"  value="{{$data->assetVehicle->registration_status ?? ''}}" placeholder="Enter Registration Status" >
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="temporary_registration_number" id="temporary_registration_number" value="{{$data->assetVehicle->temproary_reg_number ?? ''}}"  placeholder="Enter Temporary Registration Number">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control bg-white" name="temporary_registration_date" id="temporary_registration_date" value="{{$data->assetVehicle->temproary_reg_date ?? ''}}"  placeholder="Enter Temporary Registration Date">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control bg-white" name="temporary_registration_expiry_date" id="temporary_registration_expiry_date" value="{{$data->assetVehicle->temproary_reg_expiry_date ?? ''}}"  placeholder="Enter Temporary Registration Expiry Date">
                            </div>
                        </div>
                         ...
                         <div class="col-md-6 mb-3">
                           ...
                           <?php
                            // $image_temproary = !empty($data->assetVehicle->temproary_reg_attachment)
                            //     ? asset("EV/asset_master/temporary_certificate_attachments/{$data->assetVehicle->temproary_reg_attachment}")
                            //     : asset("admin-assets/img/defualt_upload_img.jpg");
                            
                            $temporaryAttachment = $data->assetVehicle->temproary_reg_attachment ?? '';
                                $defaultImage = asset('admin-assets/img/defualt_upload_img.jpg');
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="permanent_reg_number" id="permanent_reg_number"  value="{{$data->assetVehicle->permanent_reg_number ?? ''}}" placeholder="Enter Permanent Registration Number" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control bg-white" name="permanent_reg_date" id="permanent_reg_date"  value="{{ $data->assetVehicle->permanent_reg_date ? date('Y-m-d', strtotime($data->assetVehicle->permanent_reg_date)) : '' }}" placeholder="Enter Permanent Registration Number" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control bg-white" name="reg_certificate_expiry_date" id="reg_certificate_expiry_date"  value="{{ $data->assetVehicle->reg_certificate_expiry_date ? date('Y-m-d', strtotime($data->assetVehicle->reg_certificate_expiry_date)) : '' }}" placeholder="Enter Registration Certificate Expiry Date" >
                            </div>
                        </div>
                       ...
                       <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="File" class="form-control bg-white" name="hsrp_certificate_attachment" id="hsrp_certificate_img" accept="image/png,image/jpeg,image/jpg,application/pdf" onchange="showImagePreview(this,'hsrp_certificate_Image')">
                                  ...
                                  <?php
                            // $image_hsrp = !empty($data->assetVehicle->hsrp_copy_attachment)
                            //     ? asset("EV/asset_master/hsrp_certificate_attachments/{$data->assetVehicle->hsrp_copy_attachment}")
                            //     : asset("admin-assets/img/defualt_upload_img.jpg");
                            
                            $hsrpAttachment = $data->assetVehicle->hsrp_copy_attachment ?? '';
                            $defaultImage = asset('admin-assets/img/defualt_upload_img.jpg');
                        ...
                        <?php
                            // $image_src2 = !empty($data->assetVehicle->reg_certificate_attachment)
                            //     ? asset("EV/asset_master/reg_certificate_attachments/{$data->assetVehicle->reg_certificate_attachment}")
                            //     : asset("admin-assets/img/defualt_upload_img.jpg");
                            
                        $regAttachment = $data->assetVehicle->reg_certificate_attachment ?? '';
                        $defaultImage = asset('admin-assets/img/defualt_upload_img.jpg');
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="date" 
                                   ...
                                   name="fc_expiry_date" 
                                   id="fc_expiry_date" 
                                   value="{{ $data->assetVehicle->fc_expiry_date ? date('Y-m-d', strtotime($data->assetVehicle->fc_expiry_date)) : '' }}" 
                                   >
                        ...
                        <?php
                            // $image_src3 = !empty($data->assetVehicle->fc_attachment)
                            //     ? asset("EV/asset_master/fc_attachments/{$data->assetVehicle->fc_attachment}")
                            //     : asset("admin-assets/img/defualt_upload_img.jpg");
                            
                     $fcAttachment = $data->assetVehicle->fc_attachment ?? '';
                    $defaultImage = asset('admin-assets/img/defualt_upload_img.jpg');
                    ...
                    $fcImageSrc = (!$fcFilePath || $isFcPDF) ? $defaultImage : $fcFilePath;
                       ...
                       <img id="fc_attachment_Image"
                         ...
                         <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="servicing_dates" id="servicing_dates"   value="{{$data->assetVehicle->servicing_dates ?? ''}}" placeholder="Enter Servicing Dates">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <select class="form-control bg-white" name="road_tax_applicable" id="road_tax_applicable">
                             <option value="yes" {{ (isset($data->assetVehicle->road_tax_applicable) && $data->assetVehicle->road_tax_applicable == 'yes') ? 'selected' : '' }}>Yes</option>
                             <option value="no" {{ (isset($data->assetVehicle->road_tax_applicable) && $data->assetVehicle->road_tax_applicable == 'no') ? 'selected' : '' }}>No</option>
                            </select>
                          </div>
                        </div>
                         ...
                         <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="road_tax_amount" id="road_tax_amount"  value="{{$data->assetVehicle->road_tax_amount ?? ''}}" placeholder="Enter Road Tax Amount">
                            </div>
                        </div>
                     <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <label class="input-label mb-2 ms-1" for="road_tax_renewal_frequency">Road Tax Renewal Frequency</label>
                                <input type="text" class="form-control bg-white" name="road_tax_renewal_frequency" id="road_tax_renewal_frequency"  value="{{$data->assetVehicle->road_tax_renewal_frequency ?? ''}}"  placeholder="Enter Road Tax Frequency">
                            </div>
                        </div>
                         ...
                         <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control bg-white" name="next_renewal_date" id="next_renewal_date"  value="{{$data->assetVehicle->road_tax_next_renewal_date ?? ''}}" placeholder="Enter If Yes Road Tax Next Renewal Date">
                            </div>
                        </div>
                     <div class="col-md-6 mb-3">
                         </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <!--<input type="text" class="form-control bg-white" name="battery_type" id="battery_type"  value="{{$data->assetVehicle->battery_type ?? ''}}" placeholder="Enter Battery Type" >-->
                                    <select name="battery_type" id="battery_type" class="form-control bg-white">
                                    <option value="">Select</option>
                                     <option value="1" {{ (isset($data->assetVehicle->battery_type) && $data->assetVehicle->battery_type == 1) ? 'selected' : '' }}>Self-Charging</option>
                                    <option value="2" {{ (isset($data->assetVehicle->battery_type) && $data->assetVehicle->battery_type == 2) ? 'selected' : '' }}>Portable</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3" hidden>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="battery_variant_name" id="battery_variant_name"  value="{{$data->assetVehicle->battery_variant_name ?? ''}}" placeholder="Enter Battery Variant Name" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="battery_serial_no" id="battery_serial_no"  value="{{$data->assetVehicle->battery_serial_no ?? ''}}" placeholder="Enter Battery Serial Number - Original" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="battery_serial_no_replacement1" id="battery_serial_no_replacement1"  value="{{$data->assetVehicle->battery_serial_number1 ?? ''}}" placeholder="Enter Battery Serial Number - Replacement 1">
                            </div>
                        </div>
                     ...
                     <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="battery_serial_no_replacement2" id="battery_serial_no_replacement2"  value="{{$data->assetVehicle->battery_serial_number2 ?? ''}}" placeholder="Enter Battery Serial Number - Replacement 2">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="battery_serial_no_replacement3" id="battery_serial_no_replacement3"  value="{{$data->assetVehicle->battery_serial_number3 ?? ''}}" placeholder="Enter Battery Serial Number - Replacement 3">
                            </div>
                        </div>
                       ...
                       <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="battery_serial_no_replacement4" id="battery_serial_no_replacement4"  value="{{$data->assetVehicle->battery_serial_number4 ?? ''}}" placeholder="Enter Battery Serial Number - Replacement 4">
                            </div>
                        </div>
                      ...
                      <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="battery_serial_no_replacement5" id="battery_serial_no_replacement5"  value="{{$data->assetVehicle->battery_serial_number5 ?? ''}}" placeholder="Enter Battery Serial Number - Replacement 5">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <!--<input type="text" class="form-control bg-white" name="charger_variant_name" id="charger_variant_name"  value="{{$data->assetVehicle->charger_variant_name ?? ''}}" placeholder="Enter Charger Variant Name" >-->
                                  <select name="charger_variant_name" id="charger_variant_name" class="form-control bg-white">
                                    <option value="">Select</option>
                                   <option value="ABC" {{ (isset($data->assetVehicle->charger_variant_name) && $data->assetVehicle->charger_variant_name == 'ABC') ? 'selected' : '' }}>ABC</option>
                                    <option value="XYZ" {{ (isset($data->assetVehicle->charger_variant_name) && $data->assetVehicle->charger_variant_name == 'XYZ') ? 'selected' : '' }}>XYZ</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="charger_serial_no" id="charger_serial_no"  value="{{$data->assetVehicle->charger_serial_no ?? ''}}" placeholder="Enter Charger Serial Number - Original" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="charger_serial_no_replacement1" id="charger_serial_no_replacement1" value="{{$data->assetVehicle->charger_serial_number1 ?? ''}}" placeholder="Enter Charger Serial Number - Replacement 1">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="charger_serial_no_replacement2" id="charger_serial_no_replacement2"  value="{{$data->assetVehicle->charger_serial_number2 ?? ''}}" placeholder="Enter Charger Serial Number - Replacement 2">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="charger_serial_no_replacement3" id="charger_serial_no_replacement3"  value="{{$data->assetVehicle->charger_serial_number3 ?? ''}}"  placeholder="Enter Charger Serial Number - Replacement 3">
                            </div>
                        </div>
                       ...
                       <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="charger_serial_no_replacement4" id="charger_serial_no_replacement4"  value="{{$data->assetVehicle->charger_serial_number4 ?? ''}}" placeholder="Enter Charger Serial Number - Replacement 4">
                            </div>
                        </div>
                      ...
                      <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="charger_serial_no_replacement5" id="charger_serial_no_replacement5"  value="{{$data->assetVehicle->charger_serial_number5 ?? ''}}" placeholder="Enter Charger Serial Number - Replacement 5">
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="telematics_variant_name" id="telematics_variant_name"  value="{{$data->assetVehicle->telematics_variant_name ?? ''}}" placeholder="Enter Telematics Variant Name" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select custom-select2-field form-control-sm" name="telematics_oem" id="telematics_oem">
                                    ...
                                    @if(isset($telematics))
                                       @foreach($telematics as $val)
                                          <option value="{{$val->id}}" {{ (isset($data->assetVehicle->telematics_oem) && $data->assetVehicle->telematics_oem == $val->id) ? 'selected' : '' }} >{{$val->name}}</option>
                                       @endforeach
                                    @endif
                                </select>
                         ...
                         <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="telematics_serial_no" id="telematics_serial_no"  value="{{$data->assetVehicle->telematics_serial_no ?? ''}}" placeholder="Enter Telematics Serial Number - Original" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="telematics_imei_no" id="telematics_imei_no"  value="{{$data->assetVehicle->telematics_imei_number ?? ''}}" placeholder="Enter Telematics IMEI Number">
                            </div>
                        </div>
                         ...
                         <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="telematics_serial_no_replacement1" id="telematics_serial_no_replacement1"  value="{{$data->assetVehicle->telematics_serial_number1 ?? ''}}" placeholder="Enter  Telematics Serial Number - Replacement 1">
                            </div>
                        </div>
                     ...
                     <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="telematics_serial_no_replacement2" id="telematics_serial_no_replacement2"  value="{{$data->assetVehicle->telematics_serial_number2 ?? ''}}" placeholder="Enter  Telematics Serial Number - Replacement 2">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="telematics_serial_no_replacement3" id="telematics_serial_no_replacement3"  value="{{$data->assetVehicle->telematics_serial_number3 ?? ''}}" placeholder="Enter  Telematics Serial Number - Replacement 3">
                            </div>
                        </div>
                       ...
                       <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="telematics_serial_no_replacement4" id="telematics_serial_no_replacement4"  value="{{$data->assetVehicle->telematics_serial_number4 ?? ''}}" placeholder="Enter  Telematics Serial Number - Replacement 4">
                            </div>
                        </div>
                      ...
                      <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="telematics_serial_no_replacement5" id="telematics_serial_no_replacement5"  value="{{$data->assetVehicle->telematics_serial_number5 ?? ''}}" placeholder="Enter  Telematics Serial Number - Replacement 5">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="client" id="client"    value="{{ optional($data->assetVehicle->customer_relation)->name ?? $data->assetVehicle->client ?? '' }}"placeholder="Enter Client" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control bg-white" name="vehicle_delivery_date" id="vehicle_delivery_date"  value="{{ $data->assetVehicle->vehicle_delivery_date ? date('Y-m-d', strtotime($data->assetVehicle->vehicle_delivery_date)) : '' }}" placeholder="Enter Vehicle Delivery Date" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <!--<input type="text" class="form-control bg-white" name="vehicle_status" id="vehicle_status"  value="{{$data->assetVehicle->vehicle_status ?? ''}}" placeholder="Enter Vehicle Status" >-->
                                ...
                                <select class="form-select custom-select2-field form-control-sm" name="vehicle_status" id="vehicle_status">
                                    ...
                                    @if(isset($inventory_locations))
                                       @foreach($inventory_locations as $val)
                                          ...
                                          <option value="{{$val->id}}" {{ (isset($data->assetVehicle->vehicle_status) && $data->assetVehicle->vehicle_status == $val->id) ? 'selected' : '' }} >{{$val->name}}</option>
                                       @endforeach
                                    @endif
                                </select>
                     ...
                     <div class="tab-pane fade" id="pills-log-section-comments" role="tabpanel" aria-labelledby="pills-log-section-comments-tab" tabindex="0">
                        <div class="card">
                                <div class="card-header" style="background:#ffeded;">
                                    <h5 style="color:#5e1b1b;" class="fw-bold">Logs</h5>
                                    <p class="mb-0" style="color:#5e1b1b;">View all Logs & Histories</p>
                                </div>
                                <div class="card-body custom-card-body">
                                     <div class="row">
                                         <div class="col-12 my-4 text-center">
                                             <h5 class="fw-bold">Vehicle ID : {{$data->assetVehicle->id}}</h5>
                                         </div>
                                        @if(isset($log_history) && count($log_history))
                                              ...
                                              <div class="col-12 mb-5">
                                                    <div class="form-group">
                                                        <div class="d-flex justify-content-between">
                                                            <div class="mb-3">
                                                                <label class="input-label">{{$val->CreatedBy->name ?? ''}} ({{$val->CreatedBy->get_role->name ?? ''}})</label><br>
                                                                <small class="input-label">{{date('d M Y h:i:s A',strtotime($val->created_at)) ?? ''}}</small>
                                                            </div>
                                                            <div class="">
                                                                @if($val->status == "initial")
                                                                <button class="btn btn-success px-5">Initial</button>
                                                                @elseif($val->status == "returned")
                                                                <button class="btn btn-danger px-5">Returned</button>
                                                                   @elseif($val->status == "running")
                                                                <button class="btn btn-warning px-5">Running</button>
                                                                @elseif($val->status == "updated")
                                                                 <button class="btn btn-primary px-5">Updated</button>
                                                                @endif
                                                            </div>
                                                            
                                                        </div>
                                                       <div class="form-group">
                                                            <textarea name="remarks" class="form-control" readonly>{{$val->remarks ?? ''}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                           @endforeach
                                        ...
                                        <div class="col-12 text-center py-5">
                                            <h6 class="text-muted">No Log History Found</h6>
                                        </div>
                                        @endif
