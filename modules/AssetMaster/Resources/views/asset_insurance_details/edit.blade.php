<x-app-layout>
    ...
    <div class="container mt-5">
        ...
        <form action="{{route('admin.Green-Drive-Ev.asset-master.asset_insurance_details_update', [$AssetInsuranceDetails->id])}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="vehicle_reg_no" name="vehicle_reg_no" 
                           value="{{ old('vehicle_reg_no', $AssetInsuranceDetails->vehicle_reg_no) }}" 
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="Insurance_Vendor_3rd_party" name="Insurance_Vendor_3rd_party" 
                           value="{{ old('Insurance_Vendor_3rd_party', $AssetInsuranceDetails->Insurance_Vendor_3rd_party) }}" 
                           placeholder="Enter Insurance Vendor (3rd Party)">
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="Policy_Number_3rd_party" name="Policy_Number_3rd_party" 
                           value="{{ old('Policy_Number_3rd_party', $AssetInsuranceDetails->Policy_Number_3rd_party) }}" 
                           placeholder="Enter Policy Number (3rd Party)">
                </div>
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control" id="Start_date_3rd_party" name="Start_date_3rd_party" 
                           value="{{ old('Start_date_3rd_party', optional($AssetInsuranceDetails->Start_date_3rd_party)->format('Y-m-d')) }}">
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control" id="End_date_3rd_party" name="End_date_3rd_party" 
                           value="{{ old('End_date_3rd_party', optional($AssetInsuranceDetails->End_date_3rd_party)->format('Y-m-d')) }}">
                </div>
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" id="Declared_Value_3rd_party" name="Declared_Value_3rd_party" 
                           value="{{ old('Declared_Value_3rd_party', $AssetInsuranceDetails->Declared_Value_3rd_party) }}" 
                           placeholder="Enter Declared Value (3rd Party)">
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="Policy_Number_OD" name="Policy_Number_OD" 
                           value="{{ old('Policy_Number_OD', $AssetInsuranceDetails->Policy_Number_OD) }}" 
                           placeholder="Enter Policy Number (Own Damage)">
                </div>
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control" id="Start_date_OD" name="Start_date_OD" 
                           value="{{ old('Start_date_OD', optional($AssetInsuranceDetails->Start_date_OD)->format('Y-m-d')) }}">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control" id="End_date_OD" name="End_date_OD" 
                           value="{{ old('End_date_OD', optional($AssetInsuranceDetails->End_date_OD)->format('Y-m-d')) }}">
                </div>
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" id="Declared_Value_OD" name="Declared_Value_OD" 
                           value="{{ old('Declared_Value_OD', $AssetInsuranceDetails->Declared_Value_OD) }}" 
                           placeholder="Enter Declared Value (Own Damage)">
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <select class="form-control" id="Insurance_Status_OD" name="Insurance_Status_OD">
                        <option value="Active" {{ old('Insurance_Status_OD', $AssetInsuranceDetails->Insurance_Status_OD) == 'Active' ? 'selected' : '' }}>Active</option>
                        <option value="Expired" {{ old('Insurance_Status_OD', $AssetInsuranceDetails->Insurance_Status_OD) == 'Expired' ? 'selected' : '' }}>Expired</option>
                        <option value="Pending" {{ old('Insurance_Status_OD', $AssetInsuranceDetails->Insurance_Status_OD) == 'Pending' ? 'selected' : '' }}>Pending</option>
                    </select>
                </div>
            </div>
                    ...
                    <select name="Chassis_Serial_No" id="Chassis_Serial_No" class="form-control @error('Chassis_Serial_No') is-invalid @enderror">
                        ...
                        @foreach($AssetMasterVehicle as $d)
                            <option value="{{ $d->Chassis_Serial_No }}" 
                                {{ (isset($AssetInsuranceDetails) && $AssetInsuranceDetails->Chassis_Serial_No == $d->Chassis_Serial_No) ? 'selected' : '' }}>
                                {{ $d->Chassis_Serial_No }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <div class="upload-area" id="insurance_file_upload" onclick="document.getElementById('insurance_file').click();">
                        ...
                        <div class="upload-content">
                            <img id="insurance_file_preview" style="display: {{ $AssetInsuranceDetails->insurance_file ? 'block' : 'none' }};" class="preview-img" src="{{ asset('public/EV/images/Insurance/'.$AssetInsuranceDetails->insurance_file) }}" alt="Insurance Preview" />
