                ...
                <div class="card-header" style="background:#fbfbfb;">
                    <div class="row g-3">
                        <div class="col-md-6 d-flex align-items-center">
                            <div class="card-title h5 custom-dark m-0"><a href="{{ route('admin.asset_management.asset_master.dashboard') }}" class="btn btn-sm shadow me-2"><i class="bi bi-arrow-left"></i> </a>Location Master <span class="badge text-muted shadow ms-2 p-2" style="background:rgb(234,234,234);">{{$list->count()}}</span></div>
                        ...
                        <div class="col-md-6 d-flex gap-2 align-items-center justify-content-end">
                            ...
                            <div class="text-center d-flex gap-2">
                                <div class="m-2 bg-white p-2 px-3 border-gray"><a href="{{route('admin.asset_management.location_master.export_location_master', ['status' => $status, 'from_date' => $from_date, 'to_date' => $to_date])}}" class=" bg-white text-dark"><i class="bi bi-download fs-17 me-1"></i> Export</a></div>
                                ...
                                <div class="m-2 btn btn-success d-flex align-items-center px-3"
                                    onclick="window.location.href='{{route('admin.asset_management.location_master.create_location_master')}}'"
                    ...
                    <table class="table custom-table text-center" style="width: 100%;">
                        <thead class="bg-white rounded" style="background:white !important; color:black !important;">
                            <tr>
                                ...
                                <th scope="col" class="custom-dark">State</th>
                        ...
                        @if(isset($list))
                            @foreach($list as $val)
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:left;">{{ $val->state_relation->state_name ?? '' }}</td>
                                    <td style="text-align:left;">{{ \Modules\City\Entities\City::find($val->city)->city_name ?? '' }}</td>
                                    <td style="text-align:left;">{{ date('d M Y h:i:s A',strtotime($val->created_at)) }}</td>
                                   ...
                                   <td>
                                      <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                          <li>
                                            <a href="{{ route('admin.asset_management.location_master.view_location_master', ['id' => $val->id]) }}" class="dropdown-item d-flex align-items-center justify-content-center">
                                              <i class="bi bi-eye me-2 fs-5"></i> View
                                            </a>
                                          </li>
                                          <li>
                                            <a href="{{ route('admin.asset_management.location_master.update_location_master', ['id' => $val->id]) }}" class="dropdown-item d-flex align-items-center justify-content-center">
      ...
      <div class="modal fade" id="export_select_fields_modal" tabindex="-1" aria-labelledby="export_select_fields_modalLabel" aria-hidden="true">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRightHR01" aria-labelledby="offcanvasRightHR01Label">
          <div class="offcanvas-header">
            <h5 class="custom-dark" id="offcanvasRightHR01Label">Location Master</h5>
...
<script>
    ...
    $('.toggle-status').change(function (e) {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: `You are about to ${intendedStatus ? 'activate' : 'deactivate'} this location.`,
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                // Proceed with AJAX
                $.ajax({
                    url: "{{ route('admin.asset_management.location_master.status_update') }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
                        id: brandId,
