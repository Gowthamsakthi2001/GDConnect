<x-app-layout>
    <div class="container mt-5">
        ...
        <form action="{{route('admin.Green-Drive-Ev.asset-master.modal_master_battery_update',[$ModelMasterBattery->id])}}" method="POST">
            @csrf <!-- Laravel CSRF Token -->
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="name" class="form-label">Name</label>
                    <input type="text" class="form-control" id="name" name="name" 
                           value="{{ old('name',$ModelMasterBattery->name) }}" placeholder="Enter Battery Name" required>
                </div>
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="manufacturer_name" name="manufacturer_name" 
                           value="{{ old('manufacturer_name',$ModelMasterBattery->manufacturer_name) }}" placeholder="Enter Manufacturer Name" required>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" step="0.1" class="form-control" id="current_rating_Ah" name="current_rating_Ah" 
                           value="{{ old('current_rating_Ah',$ModelMasterBattery->current_rating_Ah) }}" placeholder="Enter Current Rating (Ah)" required>
                </div>
                <div class="col-md-6">
                    <label for="type" class="form-label">Type</label>
                    <input type="text" class="form-control" id="type" name="type" 
                           value="{{ old('type',$ModelMasterBattery->type) }}" placeholder="Enter Battery Type" required>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="cell_chemistry" name="cell_chemistry" 
                           value="{{ old('cell_chemistry',$ModelMasterBattery->cell_chemistry) }}" placeholder="Enter Cell Chemistry" required>
                </div>
                <div class="col-md-6">
                    ...
                    <input type="number" step="0.1" class="form-control" id="nominal_voltage" name="nominal_voltage" 
                           value="{{ old('nominal_voltage',$ModelMasterBattery->nominal_voltage) }}" placeholder="Enter Nominal Voltage" required>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" step="0.1" class="form-control" id="max_discharge_rate_c" name="max_discharge_rate_c" 
                           value="{{ old('max_discharge_rate_c',$ModelMasterBattery->max_discharge_rate_c) }}" placeholder="Enter Max Discharge Rate (C)" required>
                </div>
                <div class="col-md-6">
                    ...
                    <input type="number" step="0.1" class="form-control" id="max_voltage" name="max_voltage" 
                           value="{{ old('max_voltage',$ModelMasterBattery->max_voltage) }}" placeholder="Enter Max Voltage" required>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" step="0.1" class="form-control" id="min_voltage" name="min_voltage" 
                           value="{{ old('min_voltage',$ModelMasterBattery->min_voltage) }}" placeholder="Enter Min Voltage" required>
                </div>
                <div class="col-md-6">
                    <label for="weight_kg" class="form-label">Weight (kg)</label>
                    <input type="number" step="0.1" class="form-control" id="weight_kg" name="weight_kg" 
                           value="{{ old('weight_kg',$ModelMasterBattery->weight_kg) }}" placeholder="Enter Weight (kg)" required>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="connector_type" name="connector_type" 
                           value="{{ old('connector_type',$ModelMasterBattery->connector_type) }}" placeholder="Enter Connector Type" required>
                </div>
                <div class="col-md-6">
                    ...
                    <select class="form-control" id="telematics_enabled" name="telematics_enabled" required>
                        <option value="1" {{ old('telematics_enabled', $ModelMasterBattery->telematics_enabled) == '1' ? 'selected' : '' }}>Yes</option>
                        <option value="0" {{ old('telematics_enabled', $ModelMasterBattery->telematics_enabled) == '0' ? 'selected' : '' }}>No</option>
                    </select>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="type_of_telematics" name="type_of_telematics" 
                           value="{{ old('type_of_telematics',$ModelMasterBattery->type_of_telematics) }}" placeholder="Enter Type of Telematics">
                </div>
                <div class="col-md-6">
                    ...
                    <select class="form-control" id="smart_bms_available" name="smart_bms_available" required>
                        <option value="1" {{ old('smart_bms_available',$ModelMasterBattery->smart_bms_available) == '1' ? 'selected' : '' }}>Yes</option>
                        <option value="0" {{ old('smart_bms_available',$ModelMasterBattery->smart_bms_available) == '0' ? 'selected' : '' }}>No</option>
                    </select>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="smart_bms_features" name="smart_bms_features" 
                           value="{{ old('smart_bms_features',$ModelMasterBattery->smart_bms_features) }}" placeholder="Enter Smart BMS Features">
                </div>
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="cell_structure" name="cell_structure" 
                           value="{{ old('cell_structure',$ModelMasterBattery->cell_structure) }}" placeholder="Enter Cell Structure">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="cell_model" name="cell_model" 
                           value="{{ old('cell_model',$ModelMasterBattery->cell_model) }}" placeholder="Enter Cell Model">
                </div>
                <div class="col-md-6">
                    <label for="ip_rating" class="form-label">IP Rating</label>
                    <input type="text" class="form-control" id="ip_rating" name="ip_rating" 
                           value="{{ old('ip_rating',$ModelMasterBattery->ip_rating) }}" placeholder="Enter IP Rating">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" step="0.1" class="form-control" id="dod_percentage" name="dod_percentage" 
                           value="{{ old('dod_percentage',$ModelMasterBattery->dod_percentage) }}" placeholder="Enter DOD Percentage">
                </div>
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="connector_rating" name="connector_rating" 
                           value="{{ old('connector_rating',$ModelMasterBattery->connector_rating) }}" placeholder="Enter Connector Rating">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" id="warranty_expiry_cycles" name="warranty_expiry_cycles" 
                           value="{{ old('warranty_expiry_cycles',$ModelMasterBattery->warranty_expiry_cycles) }}" placeholder="Enter Warranty Expiry Cycles">
                </div>
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="warranty_expiry_duration" name="warranty_expiry_duration" 
                           value="{{ old('warranty_expiry_duration',$ModelMasterBattery->warranty_expiry_duration) }}" placeholder="Enter Warranty Expiry Duration">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" id="warranty_expiry_param_priority" name="warranty_expiry_param_priority" 
                           value="{{ old('warranty_expiry_param_priority',$ModelMasterBattery->warranty_expiry_param_priority) }}" placeholder="Enter Warranty Expiry Param Priority">
                </div>
                <div class="col-md-6">
                    <label for="status" class="form-label">Status</label>
                    <select class="form-control" id="status" name="status" required>
                        <option value="1" {{ old('status',$ModelMasterBattery->status) == '1' ? 'selected' : '' }}>Active</option>
                        <option value="0" {{ old('status',$ModelMasterBattery->status) == '0' ? 'selected' : '' }}>Inactive</option>
                    </select>
                </div>
            </div>
