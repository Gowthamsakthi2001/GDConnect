<x-app-layout>
    <div class="container mt-5">
        ...
        <form action="{{route('admin.Green-Drive-Ev.asset-master.po_table_store')}}" method="POST">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="AMS_Location" name="AMS_Location" 
                           value="{{ old('AMS_Location') }}" placeholder="Enter AMS Location" required>
                </div>
                <div class="col-md-6">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="Supplier_Name" name="Supplier_Name" 
                           value="{{ old('Supplier_Name') }}" placeholder="Enter Supplier Name" required>
                </div>
                <div class="col-md-6">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control" id="PO_Date" name="PO_Date" 
                           value="{{ old('PO_Date',\Carbon\Carbon::now()->format('Y-m-d')) }}" required>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" id="Other_Amount" name="Other_Amount" 
                           value="{{ old('Other_Amount') }}" placeholder="Enter Other Amount">
                </div>
                <div class="col-md-6">
                    <label for="Tax_Amount" class="form-label">Tax Amount</label>
                    <input type="number" class="form-control" id="Tax_Amount" name="Tax_Amount" 
                           value="{{ old('Tax_Amount') }}" placeholder="Enter Tax Amount">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control" id="Delivery_Date" name="Delivery_Date" 
                           value="{{ old('Delivery_Date',\Carbon\Carbon::now()->format('Y-m-d')) }}" required>
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <textarea class="form-control" id="Description" name="Description" 
                              placeholder="Enter Description" rows="2">{{ old('Description') }}</textarea>
                </div>
            </div>
