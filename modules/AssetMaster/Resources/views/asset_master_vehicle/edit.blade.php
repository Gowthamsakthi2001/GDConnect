<x-app-layout>
    ...
    <div class="container mt-5">
        ...
        <form action="{{route('admin.Green-Drive-Ev.asset-master.asset_master_vehicle_update',[$AssetMasterVehicle->id])}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="Reg_No" name="Reg_No" 
                           value="{{ old('Reg_No',$AssetMasterVehicle->Reg_No) }}" placeholder="Enter Registration Number" required>
                </div>
                <div class="col-md-6">
                    <label for="Model" class="form-label">Model <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="Model" name="Model" 
                           value="{{ old('Model',$AssetMasterVehicle->Model) }}" placeholder="Enter Model" required>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="Manufacturer" name="Manufacturer" 
                           value="{{ old('Manufacturer',$AssetMasterVehicle->Manufacturer) }}" placeholder="Enter Manufacturer">
                </div>
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="Original_Motor_ID" name="Original_Motor_ID" 
                           value="{{ old('Original_Motor_ID',$AssetMasterVehicle->Original_Motor_ID) }}" placeholder="Enter Original Motor ID">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="Chassis_Serial_No" name="Chassis_Serial_No" 
                           value="{{ old('Chassis_Serial_No',$AssetMasterVehicle->Chassis_Serial_No) }}" placeholder="Enter Chassis Serial Number">
                </div>
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" id="Purchase_order_ID" name="Purchase_order_ID" 
                           value="{{ old('Purchase_order_ID',$AssetMasterVehicle->Purchase_order_ID) }}" placeholder="Enter Purchase Order ID">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" id="Warranty_Kilometers" name="Warranty_Kilometers" 
                           value="{{ old('Warranty_Kilometers',$AssetMasterVehicle->Warranty_Kilometers) }}" placeholder="Enter Warranty Kilometers">
                </div>
                <div class="col-md-6">
                    <label for="Hub" class="form-label">Hub <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="Hub" name="Hub" 
                           value="{{ old('Hub',$AssetMasterVehicle->Hub) }}" placeholder="Enter Hub">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="Client" name="Client" 
                           value="{{ old('Client',$AssetMasterVehicle->Client) }}" placeholder="Enter Client">
                </div>
                <div class="col-md-6">
                    <label for="Colour" class="form-label">Colour <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="Colour" name="Colour" 
                           value="{{ old('Colour',$AssetMasterVehicle->Colour) }}" placeholder="Enter Colour">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control" id="Asset_In_Use_Date" name="Asset_In_Use_Date" 
                           value="{{ old('Asset_In_Use_Date',optional($AssetMasterVehicle->Asset_In_Use_Date)->format('Y-m-d')) }}">
                </div>
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="Deployed_To" name="Deployed_To" 
                           value="{{ old('Deployed_To',$AssetMasterVehicle->Deployed_To) }}" placeholder="Enter Deployed To">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="Emp_ID" name="Emp_ID" 
                           value="{{ old('Emp_ID',$AssetMasterVehicle->Emp_ID) }}" placeholder="Enter Employee ID">
                </div>
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control" id="Procurement_Lease_Start_Date" name="Procurement_Lease_Start_Date" 
                           value="{{ old('Procurement_Lease_Start_Date',optional($AssetMasterVehicle->Procurement_Lease_Start_Date)->format('Y-m-d')) }}">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control" id="Lease_Rental_End_Date" name="Lease_Rental_End_Date" 
                           value="{{ old('Lease_Rental_End_Date',optional($AssetMasterVehicle->Lease_Rental_End_Date)->format('Y-m-d')) }}">
                </div>
                <div class="col-md-6">
                    ...
                    <textarea class="form-control" id="PO_Description" name="PO_Description" 
                              placeholder="Enter PO Description">{{ old('PO_Description',$AssetMasterVehicle->PO_Description) }}</textarea>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="Registration_Type" name="Registration_Type" 
                           value="{{ old('Registration_Type',$AssetMasterVehicle->Registration_Type) }}" placeholder="Enter Registration Type">
                </div>
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="Ownership_Type" name="Ownership_Type" 
                           value="{{ old('Ownership_Type',$AssetMasterVehicle->Ownership_Type) }}" placeholder="Enter Ownership Type">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" id="Lease_Value" name="Lease_Value" 
                           value="{{ old('Lease_Value',$AssetMasterVehicle->Lease_Value) }}" placeholder="Enter Lease Value">
                </div>
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="AMS_Location" name="AMS_Location" 
                           value="{{ old('AMS_Location',$AssetMasterVehicle->AMS_Location) }}" placeholder="Enter AMS Location">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="Parking_Location" class="form-label">Parking Location <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="Parking_Location" name="Parking_Location" 
                           value="{{ old('Parking_Location',$AssetMasterVehicle->Parking_Location) }}" placeholder="Enter Parking Location">
                </div>
                <div class="col-md-6">
                    ...
                    <select class="form-control" id="Asset_Status" name="Asset_Status">
                        @if(isset($asset_status))
                            @foreach($asset_status as $status)
                              <option value="{{$status->id}}" {{ $AssetMasterVehicle->Asset_Status == $status->id ? 'selected' : '' }}>{{$status->status_name}}</option>
                            @endforeach
                        @endif
                    </select>
                </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="Sub_Status" name="Sub_Status" 
                           value="{{ old('Sub_Status',$AssetMasterVehicle->Sub_Status) }}" placeholder="Enter Sub Status">
                </div>
                <div class="col-md-6">
                    ...
                    <select class="form-control" id="is_swappable" name="is_swappable">
                        <option value="1" {{ old('is_swappable',$AssetMasterVehicle->is_swappable) == '1' ? 'selected' : '' }}>Yes</option>
                        <option value="0" {{ old('is_swappable',$AssetMasterVehicle->is_swappable) == '0' ? 'selected' : '' }}>No</option>
                    </select>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <!--            <option value="{{ $dm->id }}" {{ old('dm_id', $AssetMasterVehicle->dm_id) == $dm->id ? 'selected' : '' }}>-->
                    ...
                    <div class="form-group">
                        ...
                        <div class="upload-area" id="rc_book_file_upload" onclick="document.getElementById('rc_book_file').click();">
                            ...
                            <div class="upload-content">
                                <img id="rc_book_file_preview" 
                                     style="display: {{ $AssetMasterVehicle->rc_book ? 'block' : 'none' }};" 
                                     class="preview-img" 
                                     src="{{ asset('public/EV/images/rc_book/'.$AssetMasterVehicle->rc_book) }}" 
                                     alt="RC Book Preview" />
