                ...
                <div class="card-header" style="background:#fbfbfb;">
                    <div class="row g-3">
                        <div class="col-md-4 d-flex align-items-center">
                              <div class="card-title h5 custom-dark m-0"> <a href="{{route('admin.asset_management.quality_check.list')}}" class="btn btn-sm shadow me-2"><i class="bi bi-arrow-left"></i> </a>Bulk Upload Table
                        ...
                        <div class="col-md-8 d-flex gap-2 align-items-center justify-content-end">
                            <div class="text-center d-flex gap-2">
                                ...
                                <a href="{{route('admin.asset_management.quality_check.bulk_upload_form')}}" class="m-2 btn btn-success p-2 px-3"><i class="bi bi-plus fs-17 me-1 fw-bold"></i> Create </a>
                            </div>
                        </div>
                              ...
                              <td>
                                  <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                     <li>
                                      <a href="{{route('admin.asset_management.quality_check.total_qc_list',['id'=>1])}}" class="dropdown-item d-flex align-items-center justify-content-center">
                            ...
                            <tr>
                              ...
                              <td>
                                  <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                       <li>
                                        <a href="{{route('admin.asset_management.quality_check.total_qc_list',['id'=>2])}}" class="dropdown-item d-flex align-items-center justify-content-center">
                                                  <i class="bi bi-eye me-2 fs-5"></i> View
                                               </a>
                                        </li>
                                    </ul>
