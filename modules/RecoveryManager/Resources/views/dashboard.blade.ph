    ...
    <div class="row mt-3">
        <div class="col-md-12 col-sm-12">
            <div class="card-metric bg-white">
                ...
                <h2 id="recovery-count">{{ $recovery_count['current'] ?? 0 }}</h2>
