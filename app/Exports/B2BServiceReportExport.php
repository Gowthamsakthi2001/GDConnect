...
class B2BServiceReportExport implements FromCollection, WithHeadings, WithMapping
{
    ...
    public function __construct($date_range, $from_date, $to_date, $vehicle_type, $city, $zone, $vehicle_no = [] ,$accountability_type ,$status) 
    {
