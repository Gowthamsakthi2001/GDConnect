...
use Modules\MasterManagement\Entities\CustomerTypeMaster; //updated by Mugesh.B
use Illuminate\Support\Facades\DB;
class CustomerTypeMasterExport implements FromCollection, WithHeadings, WithMapping
{
     protected $status;
     protected $from_date;
     protected $to_date;
